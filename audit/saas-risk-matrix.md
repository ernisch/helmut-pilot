...
| 6 | Demo-Profile (`angela-merkel`, `james-brown`) in Produktion | `helmut_store.main` / `profiles` (Live-Query) | Sicher (vorhanden) | Niedrig–Mittel (Verwechslung, Hygiene) | Niedrig | Mittel | Nein | Vor Vertrieb löschen; Prod von Testdaten trennen | **P2** |
