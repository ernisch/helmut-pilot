...
//
// Inhalt: rein FIKTIV, keine reale Partei/Person (keine Cem-Logik, keine hartkodierte
...
// Flag-Parser lokal (keine zusätzliche Abhängigkeit).
function reviewFixtureEnabled() {
  return ["1", "true", "on", "yes"].includes(String(process.env.HELMUT_REVIEW_FIXTURE || "").trim().toLowerCase());
}
