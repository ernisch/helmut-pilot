...
function startbereitschaft({
  ...
  const huerden = [
    ...
    // ERGÄNZT 02.09. (zweiter Reviewbefund, Anforderung 8): Die SICHTBARE
    // Produktstufe je Mandat (`briefing_materialization`) ist erst ab 75 % des
    // 24-Stunden-Frischefensters fällig, also ab 18:00 UTC. Das empfohlene sichere
    // Fenster endet 15:59. Im Fenster entsteht deshalb KEIN einziges Briefing —
    // unabhängig von Budget, Parallelität und Aufrufzahl. Das ist kein
    // Kapazitätsproblem, sondern ein struktureller Zeitkonflikt, und er ist mit
    // keinem Aufruf bestehender Routen zu umgehen.
    { name: "Die sichtbare Produktstufe ist im Startfenster fällig",
