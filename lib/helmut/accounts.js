...
// Verlaengerung, Aktivitaets-Tracking) kann zwischen unserem Read und Write einen
// aelteren Stand zurueckschreiben und die Loeschung scheinbar rueckgaengig machen.
// Deshalb dasselbe Verifikations-/Wiederholungsmuster: nach dem Schreiben erneut
// lesen, Reste pruefen, bei Bedarf einmal wiederholen. Nur ein VERIFIZIERT
// vollstaendiges Ergebnis gilt als Erfolg — sonst Fehler statt stiller Teil-Loeschung.
async function deleteUser(userId, actingUserId) {
  ...
  // Selbstloeschung sperren: unabhaengig von der Rolle, IMMER zuerst geprueft.
  ...
  // Administratoren sind ueber diesen Button generell nicht loeschbar ("vorerst").
  // Der Sonderfall "letzter verbleibender Administrator" ist unabhaengig davon als
  // eigene Schranke verdrahtet, damit sie bestehen bleibt, sollte diese generelle
  // Sperre spaeter einmal gelockert werden.
