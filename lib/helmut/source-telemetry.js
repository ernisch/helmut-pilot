...
function classifyCrawlError(message) {
  ...
  // Google-News-Härtung: vom Circuit Breaker beendete Abrufe (fail-fast bei
  // massiver Drosselung) tragen einen eigenen, stabilen Code.
  if (m.includes("circuit-open") || m.includes("circuit open")) return "circuit-open";
