...
const FILE_FLAG_ALLOWLIST = Object.freeze([
  ...
  "HELMUT_SOURCE_MODE",
  // Landtag-Sprint (P2-1): Landesmodul-Freigabe je Bundesland (z. B. "berlin,brandenburg").
  // Default LEER = alle Landesmodule gesperrt. Ein Wert hier ist eine Gründer-Freigabe.
  "HELMUT_LANDESMODULE"
]);
