...
const FILE_FLAG_ALLOWLIST = Object.freeze([
  ...
  "HELMUT_SOURCE_MODE",
  // Landesmodul-Freigabe JE BUNDESLAND (Komma-Liste, z. B. "berlin" oder "berlin,brandenburg").
  // Default: NICHT gesetzt = kein Landesmodul freigegeben. Der Schluessel steht hier nur auf der
  // Allowlist, damit die spaetere Freigabe ein reviewbarer Ein-Zeilen-Diff (bzw. eine
  // Vercel-Env) sein kann. Er ist in helmut-flags.json BEWUSST NICHT gesetzt — das Setzen ist
  // eine Freigabeentscheidung des Betreibers, keine Code-Entscheidung (CLAUDE.md §5).
  "HELMUT_LANDESMODUL_FREIGABE"
]);
