...
const PARTEI_ARTIKELVARIANTEN = Object.freeze(["linke", "gruenen"]);
...
function pruefeAkteurslistenQuellenbindung(antwort, prompt) {
  ...
  for (const feld of FELDER) {
    ...
    const unbelegt = liste.some(wert => {
      ...
      // Parteien: eine belegte Artikelvariante DERSELBEN Partei darf den Wert belegen
      // (nur fuer die ausdruecklich belegten Bezeichnungen; sonst gilt der Wortlaut).
