...
// Ein unbelegter `parteien`-Wert wird deshalb — genau wie ein unbelegter Erwaehnungswert —
// DETERMINISTISCH ENTFERNT, statt die ganze Antwort zu verwerfen. Damit wird KEINE unbelegte
// strukturelle Beteiligung gespeichert (der Wert entfaellt vollstaendig, in `parteien` UND in
...
const REDUZIERTE_BETEILIGUNGSFELDER = ["parteien"];
const REDUZIERBARE_FELDER = [...new Set([...MINISTERIUMSFELDER, ...ERWAEHNUNGSFELDER,
  ...REDUZIERTE_BETEILIGUNGSFELDER])];
...
//
// DESHALB: alle REDUZIERBAREN_FELDER (die Erwaeehnungslisten `mentioned_*`, die beiden belegten
// Ministeriumslisten und — Anlass 3, Production-Befund 2026-09-24 — die Beteiligungsliste
// `parteien`) werden VOR dem Speichern deterministisch auf den woertlich belegten Teil reduziert:
// unbelegte STRINGS entfallen, ohne Beleg bleibt die Liste leer.
//
