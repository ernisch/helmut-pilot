...
const DATA_CLASSES = {
  ...
  // W-2 fuer llmUsage: relationales Ziel des llmUsage-Rings (Migration
  // 20260902121500, freigabepflichtig, Flag HELMUT_LLM_USAGE_RELATIONAL Default
  // AUS). Dieselbe Klasse und dieselbe Frist wie der Blob-Ring — aber die
  // Loeschart ist eine andere: eine Tabelle kennt keinen Ringpuffer, sie wird
  // nach Alter gepurgt (wie process_runs). Ohne diesen Eintrag waere die
  // Aufbewahrungsmatrix nach der Umstellung unvollstaendig.
  llm_usage:            { klasse: "kosten-audit", art9: false, retentionDays: 365, loeschung: "purge-nach-alter" },
