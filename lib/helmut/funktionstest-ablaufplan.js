...
const V = Object.freeze({
  ...
  // BETREIBERENTSCHEIDUNG (03.09., Sicherheitsrahmen §34.7): die
  // Bundestagsreife-Sperre weist die Bundestagsprofile der Kohorte ab
  // („Testausschuss" nicht in der WP-21-Sollmenge). Solange nicht entschieden
  // ist, wie die Kohorte angelegt werden soll, darf KEINE Stufe angelegt werden.
  KOHORTE_ANLEGBAR: "kohortenspezifikation-reifesperre-entschieden",
...
function schritte() {
  ...
  const roh = [
    ...
    Object.freeze({
      id: "kohortenreife", titel: "Entscheidung zur Kohortenspezifikation (Bundestagsreife-Sperre)",
      art: ART_LESEND,
      befehl: `${LOKAL} node scripts/testkohorte-provisionierung-inaktiv-test.js  (A0 zeigt den Stand: `
        + "18 von 20 Stufe-A-Profilen abgewiesen)  →  Betreiberentscheidung nach Sicherheitsrahmen §34.7 "
        + "(a: Kohorte auf WP-21-Ausschüsse · b: Reife-Regel · c: nur Landtagsprofile)",
      vorbedingungen: Object.freeze([]),
      liefert: V.KOHORTE_ANLEGBAR,
      freigabe: Object.freeze({ art: "betreiber-entscheidung", worte: null }),
      abbruchkontrolle: null,
      zweck: "Der echte Provisionierer verweigert jedes Bundestagsprofil der Kohorte "
        + "(`bundestagsprofil-nicht-bereit`: „Testausschuss“ ist nicht in der WP-21-Sollmenge). "
        + "Ein scharfer Lauf der Stufe A endete heute mit 2 angelegt, 18 abgewiesen, ok:false — sicher, "
        + "aber unvollständig. Bis zur Entscheidung darf keine Stufe angelegt werden; diese Kennung wird "
        + "nur durch die dokumentierte Entscheidung belegt, nie durch einen Lauf."
    }),
  ...
  return Object.freeze({
    ...
    blocker: Object.freeze({
      kohortenreife: {
        ...
        beleg: "Sicherheitsrahmen §34.7 — Bundestagsreife-Sperre weist 18 von 20 Stufe-A-Profilen ab",
        entschieden: erbracht.has(V.KOHORTE_ANLEGBAR)
      }
    }),
