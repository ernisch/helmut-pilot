...
function prettySourceType(doc = {}) {
  // Landtag-Sprint (P2-5): Labels fuer amtliche Landes-Typen (additiv, Bund unveraendert).
  const map = {
    ...
    parliamentary_group: "Fraktion", authority: "Behörde", statistical_office: "Statistikamt"
  };
