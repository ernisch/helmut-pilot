...
function demoLageBriefing(profile = {}) {
  ...
  const vorgaenge = [
    { id: "vg-bundestariftreuegesetz", vorgangId: "vg-bundestariftreuegesetz", policyField: "Arbeit und Soziales", title: "Bundestariftreuegesetz", status: "update", standLabel: "Referentenentwurf liegt vor", nextStep: "Kabinettsbeschluss", updatedLabel: "Heute, 08:45", updatedDot: "today", summary: { wasIstPassiert: "Das BMAS hat den Referentenentwurf vorgelegt.", warumWichtig: "Betrifft die Tarifbindung bei öffentlichen Aufträgen.", werIstBetroffen: "Öffentliche Auftraggeber, tarifgebundene Unternehmen." }, chronologie: [{ dateLabel: "12. Juni 2025", timeLabel: "08:30", text: "BMAS veröffentlicht Referentenentwurf." }], sources: paragraphs[0].sources, documents: [{ name: "Referentenentwurf (BMAS)", kind: "PDF", sizeLabel: "1,2 MB", url: "https://bmas.de" }], sourceCount: 6 },
    { id: "vg-pflegereform", vorgangId: "vg-pflegereform", policyField: "Gesundheit", title: "Pflegereform", status: "neu", standLabel: "Eckpunkte veröffentlicht", nextStep: "Verbändeanhörung", updatedLabel: "Heute, 07:30", updatedDot: "today", summary: { wasIstPassiert: "Das BMG hat Eckpunkte vorgestellt.", warumWichtig: "Reform der Pflegeversicherung.", werIstBetroffen: "Pflegebedürftige, Pflegekassen." }, chronologie: [{ dateLabel: "12. Juni 2025", timeLabel: "07:30", text: "BMG stellt Eckpunkte vor." }], sources: paragraphs[1].sources, documents: [], sourceCount: 4 }
  ];
