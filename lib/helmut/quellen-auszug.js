...
function geleseneQuelle(document) {
  ...
  // Ein validierter Bundestags-Artikelstand traegt seinen vollstaendigen Leitabsatz
  // exakt hashgebunden als summary. Die generische 240-Zeichen-Reparatur darf ihn
  // niemals still verkuerzen; der Stand wird dabei selbst strikt validiert.
  const stand = require("./bundestag-artikelstand").leseArtikelstand(document);
