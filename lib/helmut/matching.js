...
// Die Verschaerfung greift ausschliesslich fuer Profile, deren Mandatsebene
// eindeutig ein LANDESPARLAMENT ist. Fuer Bundes- und fuer unbestimmte Profile
// bleibt das Verhalten byte-identisch — eine Verschaerfung dort wuerde aktive
// Bundestagsergebnisse veraendern und ist eine getrennte Betreiberentscheidung.
...
function landIndex() {
  ...
  for (const g of seed) {
    ...
    idx.byName.set(landNameKey(g.name), land);
  }
  LAND_INDEX = idx;
  return idx;
}
