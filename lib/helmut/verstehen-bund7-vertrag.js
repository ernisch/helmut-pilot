...
function pruefeSpeicherbindung(docs, beleg) {
  const clean = A.pruefeArtikelkontext(docs.map(kanonischeSpeicherzeiten), beleg);
...
module.exports = { BUND7, QUITTUNG, EINGABE, INHALT_HASH, BELEGE_HASH, pruefeInhalt, ausGesichertenBelegen, istVersorgung, pruefeSpeicherbindung };
