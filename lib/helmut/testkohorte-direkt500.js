...
function pruefeSnapshot(s, vorgang) {
  const ruhend = vorgang === "500-ruhend";
  ...
  fordere(geschuetzt.length === (voll ? 9 : 29) && geschuetzt.filter((m) => m.aktiv).length === (ruhend ? 0 : voll ? 5 : 25)
  ...
  fordere(geschuetzteIdentitaeten.length === (voll ? 10 : 30) && geschuetzteKonten.length === (voll ? 5 : 25)
