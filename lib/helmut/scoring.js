...
// Umsetzungsnotiz §8: preferredChannels wird jetzt serverseitig aus den Büro-Formaten
// abgeleitet (Format->Kanal, z. B. anfrage->committee_question). Diese abgeleiteten
// Kanalnamen müssen hier mitgeführt werden, sonst liefe die Kanal-Passung wieder leer.
const CHANNEL_TO_PROFILE = {
  press: ["presse", "press", "pressemitteilung"],
  social: ["social", "linkedin", "x", "twitter", "instagram"],
  internal: ["internal", "intern", "fraktion", "internal_line"],
  parliamentary: ["ausschuss", "parlament", "parliamentary", "buergerdialog", "rede", "committee_question", "citizen_dialogue"]
};
