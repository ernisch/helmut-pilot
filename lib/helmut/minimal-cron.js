...
//
// WARUM :18/:48: beide Minuten kollidieren mit KEINER bestehenden Cron-Minute
// (bestehende Minuten: 0, 10, 22, 30, 45); der kleinste Abstand ist 3 Minuten
// (05:45-Lage-Briefing zu :48). Das globale Understanding-Schloss (TTL 10 min)
// und die 280-s-Deadline schließen Überlappung zusätzlich aus: bei 30 Minuten
// Slottakt endet jeder Lauf (≤ 280 s) lange vor dem nächsten Slot.
//
...
function aktivierungsVoraussetzungen() {
  return Object.freeze([
    ...
    { schritt: "tagesdeckel", beschreibung: "HELMUT_MAX_LLM_CALLS_PER_DAY auf den berechneten Zieldeckel setzen (lib/helmut/kapazitaet-500.js; ohne Deckel-Erhöhung sind die 48 Slots wirkungslos — der Deckel bindet)." },
    { schritt: "nachweis", beschreibung: "Nach dem Deploy 2-3 natürliche Slots rein lesend prüfen (Quittungen understanding-rueckstand: Erlaubnisse ≤ Laufdeckel, Boden gehalten, budgetlose Slots enden per Vorab-Bodenprüfung in Sekunden)." }
  ]);
}
