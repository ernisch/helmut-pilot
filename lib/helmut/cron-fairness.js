...
function planTenantOrder({
  ...
  planbar.sort((a, b) => {
    // Alle Mandate folgen derselben Versuchshistorie und demselben Los.
    // Das bisherige Argument gleichberechtigt bleibt API-kompatibel, kann
    // aber keine Bevorzugung nach real/synthetisch mehr einschalten.
