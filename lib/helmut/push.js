...
async function sendPush(subscription, payload) {
  ...
  // Zweite, unabhaengige Lage des Riegels direkt an der Netzgrenze: auch ein
  // Aufrufer, der sendPushToPolitician umgeht, kommt hier nicht am Riegel vorbei.
  const riegelEndpunkt = kommunikationsriegel.pruefe({ kanal: "push", ziel: endpoint });
