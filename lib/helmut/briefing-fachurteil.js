...
function pruefe(result, urteil) {
  ...
  for (const q of quellen) {
    ...
    // gelesenes Original am selben Prueftag exakt gebunden werden. Die Notiz
    // muss fachlich tragen; der Hash beweist allein keine Richtigkeit.
