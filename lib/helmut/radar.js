...
function koToRadarSignal(ko = {}, reason, signalType) {
  ...
  return {
    ...
    signalType,
    reason,
    title: ko.display_title || ko.headline || shortText(ko.was_ist_passiert, 80) || ko.vorgang_id,
    summary: ko.display_summary || shortText(ko.was_ist_passiert),
    // Client-Kompatibilität (renderRadarV3View liest title/content/excerpt):
    content: shortText(ko.display_summary || ko.was_ist_passiert),
    excerpt: shortText(ko.display_summary || ko.was_ist_passiert),
