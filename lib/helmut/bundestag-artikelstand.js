...
function erzeugeArtikelstand(doc, beleg) {
  try {
    ...
    // (published_at bleibt null) und mit ausschliesslich den geschlossenen Stand-Metadaten.
...
module.exports = { VERSION, HERKUNFT, NAMESPACE, MAX_TITEL, BUNDESTAG_ARTIKEL_URL,
  tagDesWerts, standHashFuer, kennungFuerStand, pruefeArtikelstand, leseArtikelstand, erzeugeArtikelstand };
