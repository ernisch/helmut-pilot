...
//   3. `schreibrecht`    — prüft unmittelbar vor der Persistenz, ob das Lease noch gilt.
//   4. Fencing-Wert am Wissensobjekt — die HARTE Zusage: die Datenbank weist eine
//                          Überschreibung durch einen älteren Lauf ab (Trigger).
//   5. `abschluss`       — schließt den Vorgang mit dem persistierten Ergebnis.
//   6. `freigabe`        — bekannter Ausgang ohne Ergebnis (Budget, Modellfehler).
//
