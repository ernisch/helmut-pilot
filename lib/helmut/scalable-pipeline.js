...
async function betriebsstatus({ deps = {}, seitMinuten = 1440, env = process.env } = {}) {
  ...
  // Auch die Alterswerte muessen Zahlen >= 0 sein — eine NaN-Wartezeit wuerde sonst alle
  // Schwellenvergleiche still zu `false` machen und saehe aus wie „gruen".
  for (const feld of ["aeltester_faelliger_s", "max_mandatsalter_s", "aeltester_offener_s",
