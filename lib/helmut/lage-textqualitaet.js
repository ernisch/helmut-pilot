...
const SCHEMA = {
  ...
  properties: { pruefungen: { type: "array", items: {
    ...
    required: ["absatz", "quelle_id", "beleg", "pruefbegruendung", "vollstaendig_belegt", "themenrein", "profilbezug", "textart"],
    properties: { absatz: { type: "integer" }, quelle_id: { type: "string" }, beleg: { type: "string" },
      pruefbegruendung: { type: "string", minLength: 1, maxLength: 800,
        description: "Begruende Quellenabdeckung, Bezug zu einem konkreten Mandatsfeld und Textart. Benenne bei Ablehnung die beanstandete Aussage." },
...
function prompt(paragraphs, vorgaenge, profile) {
  return [
    ...
    "Pruefe Quellenabdeckung, Themenreinheit, Profilbezug und Textart getrennt. Fehlender Profilbezug macht einen konkreten Sachverhalt nicht zum Fuelltext. Begruende jedes Urteil kurz in pruefbegruendung; bei Ablehnung benenne die beanstandete Aussage. Nur konkrete Sachverhalte mit allen drei Wahrheitswerten true koennen bestehen.",
