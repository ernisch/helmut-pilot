...
// ============================================================================
// Bestaetigter Allowlist der 6 netto-neuen, rekonstruierbaren Vorgaenge (exakte
// vorgang_id inkl. Umlaut; Live-Bestaetigung 2026-07-17: alle pending, Seed-Docs
// vorhanden, KEIN complete-Duplikat). Die Ausfuehrung ist doppelt gesperrt:
// (1) Flag HELMUT_RECOVERY_EXECUTE (Default AUS) und (2) exaktes Bestaetigungstoken.
...
async function recoverOne(planItem, deps = {}) {
  ...
  return { vorgangId: vid, done: true, skipped: false, wrote: true, aiCalls: 1, result: res };
}
