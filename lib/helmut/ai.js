...
Pflichtformat fuer whyImportant, risk und recommendation:
- Jedes dieser drei Felder MUSS mit einem kurzen Kernsatz beginnen (max. 7 Woerter).
- Dieser erste Satz endet mit einem Punkt und steht alleine.
- Kein "Weil …"- oder "Wenn du nicht reagierst …"-Einstieg.
- Beispiel whyImportant: "Betrifft deine Kernthemen direkt. [Laengere Begruendung folgt hier.]"
- Beispiel risk: "Deutungshoheit droht verloren zu gehen. [Erklaerung folgt.]"
- Beispiel recommendation: "Linie heute vorbereiten. [Hinweis folgt.]"
...
JSON:
{
  ...
  "recommendation": "Kurze Handlungsphrase (max. 5 Woerter, Infinitiv). Dann optional ein Ergaenzungssatz.",
  "whyImportant": "Kernsatz max. 7 Woerter (kein Weil-Einstieg). Dann Begruendung.",
  "risk": "Risikostatement max. 7 Woerter (kein Wenn-Einstieg). Dann Erklaerung.",
