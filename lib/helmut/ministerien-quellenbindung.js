...
const FELDER = ["ministerien", "mentioned_ministries"];
const PROMPT_REGELN = [
...
function pruefeMinisterienQuellenbindung(antwort, prompt) {
...
module.exports = { PROMPT_REGELN, pruefeMinisterienQuellenbindung };
