...
const DEFAULT_THRESHOLDS = {
  ...
  // P2-5: auf die relationale Quellenarchitektur kalibriert (gesunder Ist-Crawl ~145),
  // nicht auf den alten Rohkatalog (450/405 waren nie erfüllbar). Server übersteuert diese
  // Defaults ohnehin mit denselben Werten aus source-coverage.js; hier für Modul-/Test-Nutzung.
  minCheckedSources: 120,
  minSuccessfulSources: 110,
  maxFailureRatio: 0.1,
  errorSpike: 15
};
