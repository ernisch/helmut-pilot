...
const coreSources = [
  ...
  directSource({
    ...
    // P1-3 (Architektur-Audit 29): verifizierte Reparatur uebernommen (Sprint 9B, real HTTP 200,
  ...
  directSource({
    ...
    // P1-3: verifizierte Reparatur uebernommen (Sprint 9B, real HTTP 200, 15 Items, 3 Tage alt).
  ...
  directSource({
    ...
    // P1-3: verifizierte Reparatur uebernommen (Sprint 9B, real HTTP 200, 20 Items, 0 Tage).
    // HTML-Scrape gegen Bot-403 + kein stabiler Ausschuss-Feed -> googlenews-Ersatz.
    rssUrl: "https://news.google.com/rss/search?q=site:bundestag.de%20%22Ausschuss%20f%C3%BCr%20Arbeit%20und%20Soziales%22",
    crawlMethod: "rss",
    priority: 95
  }),
  directSource({
  ...
  directSource({
    ...
    // P1-3: verifizierte Reparatur uebernommen (Sprint 9B, real HTTP 200, 15 Items, 0 Tage alt).
...
const v1Sources = uniqueSources([
  ...
  ...tagSources(regionalSources, { neutral: false, regional: true }),
  ...tagSources(publicBroadcastRegionalSources, { neutral: false, regional: true }),
