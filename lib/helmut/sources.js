...
const SOCIAL_THEME_TERMS = [
  ...
  "rente", "pflege", "tarifbindung", "tariftreue", "arbeitsmarkt", "sozialstaat",
...
// Direktquellen (nur bei passendem Profil), Partei-spezifisch (nur bei passender
// Partei) und die Demo-Personenquelle (nie über den geteilten Katalog).
