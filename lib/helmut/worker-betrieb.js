...
async function durchlauf({
  ...
  let spiegelBilanz = { gesammelt: 0, geschrieben: null, neuImBlob: null, verworfen: 0, fehler: null };
  if (spiegel.items.length) {
    ...
    try {
      ...
      spiegelBilanz = {
        ...
        verworfen: spiegel.verworfen, fehler: null
      };
    } catch (error) {
