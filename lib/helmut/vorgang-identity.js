...
function sameVorgang(cluster = {}, bestand = {}) {
  ...
  // Bei nur einem schwachen Kerntreffer muss JEDES neue Dokument dieselbe
  ...
  if (o.gewichtSpezifisch < MIN_BEWEISGEWICHT
    && !neueDocs.every(neu => altDocs.some(alt => docsShareEvent(neu, alt).gleich))) {
    return nein("schwacher-kern-ohne-ereignisbeleg", beleg);
  }
