...
function buildLlmUsageRecord(entry = {}, opts = {}) {
  ...
  // blockiert dann zu Recht). Kostenfrei gilt AUSSCHLIESSLICH bei ausdrücklicher
  // Kennzeichnung durch den Aufrufer (`keinAufruf: true`) UND ohne jede Token-Angabe —
  // ein widersprüchlicher Marker (usage vorhanden) fällt auf den ehrlichen
  // "unknown"-Pfad zurück. Ein unbekanntes Modell wird weiterhin NIE still mit 0 bewertet.
