...
// Wortgrenzen-sicherer Treffer fuer Personennamen/Mandats-IDs: BEIDE Seiten
// muessen echte Wortgrenzen sein. Anders als bei Themenbegriffen hilft
// Komposita-Erkennung hier nicht (niemand schreibt "Kleinreform" fuer eine Reform
// der Abgeordneten Klein), sondern erzeugt nur Fehlzuordnungen - ein Nachname wie
// "Klein", "Bauer", "Wolf" oder "Vogel" wuerde sonst in "Kleinunternehmer",
// "Bauernhof", "Wolfsburg" oder "Vogelgrippe" faelschlich anschlagen.
function hasProfileTerm(text, term) {
...
function rawItemBelongsToProfile(item = {}, profile, politicianId) {
  ...
  return terms.some((term) => hasProfileTerm(text, term));
}
