...
// OP-30 CAS: `verstehen_fencing` ist NUR eine Schreibspalte (der Lesepfad braucht sie nie).
// Sie traegt den Fencing-Wert des Verstehenslaufs; die Datenbank erzwingt darauf Monotonie
// (Trigger helmut_ko_fencing_wache, Migration 20260814180000). Ohne den CAS-Pfad setzt sie
// niemand — dann ist sie in allen Zeilen NULL und der Trigger ist wirkungslos.
const V3_KO_WRITE_COLUMNS = [...V3_KNOWLEDGE_OBJECT_COLUMNS, "embedding", "verstehen_fencing"];
...
async function jobQueueOffeneVorbedingungen({ fenster = null, typen = null } = {}) {
