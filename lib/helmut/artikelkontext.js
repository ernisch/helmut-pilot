...
function pruefeArtikelkontext(documents, beleg) {
  ...
  if (automatisch) {
    ...
    fordere(g && !Array.isArray(g) && (g.verfahren === "artikel-absatz-titel-v1" || bundestag) && g.positionsbasis === "html-article-p"
      ...
      && Number.isSafeInteger(g.titelTreffer) && g.titelTreffer >= (bundestag ? 0 : 2) && g.titelTreffer <= 100
    ...
    fordere(!bundestag || (beleg.absatzPosition === 1 && g.kandidatZahl === 1 && g.artikelTextPosition === 0), "gewinnung-ungueltig");
