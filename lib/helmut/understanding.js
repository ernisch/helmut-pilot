...
function buildUnderstandingPrompt(cluster = {}) {
  ...
  return [
    ...
    "- display_title: DER politische Lage-Titel dieses Vorgangs -- die EINE Ueberschrift, die in",
    "  ALLEN Oberflaechen (Lage, Detailansicht, Radar, Suche, Push) angezeigt wird. Er muss in",
    "  Sekunden verstaendlich und voellig ALLEIN lesbar sein (ohne den restlichen Vorgang).",
    "  Harte Regeln: hoechstens ~9 Woerter und ~60 Zeichen; ein VOLLSTAENDIGER Gedanke, KEIN",
    "  Satzanfang/-fragment; KEIN Nachrichten-/Zeitungstitel; KEINE Ellipse/'...'; KEINE",
    "  Behoerdensprache; KEINE Quellennamen; KEINE Doppelpunkt-Ketten; keine Fuellwoerter,",
    "  keine Floskeln, keine Wiederholungen, kein Clickbait; neutral, der politische Kern zuerst.",
    "  Ende NIE auf einem Funktionswort (z. B. zur/zum/fuer/von/mit/durch/und/oder/gegenueber/wegen).",
    "  Frei umformulieren -- NICHT die Originalschlagzeile kopieren oder abschneiden.",
    "  Schlecht: 'Friedrich Merz hat oeffentlich eine scharfe Ablehnung gegenueber...'",
    "  Gut:     'Merz lehnt Vergesellschaftung ab'",
    "  Schlecht: 'Im Voelklinger Stadtrat besteht Ratlosigkeit...'",
    "  Gut:     'Voelklingen ringt um Sportplaetze'",
    "  Schlecht: 'Bundesministerium fuer Arbeit und Soziales veroeffentlicht...'",
    "  Gut:     'Ministerium plant neue Arbeitsmarktreform'",
    "  Schlecht: 'Sammlung: Diverse sozialpolitische Initiativen...'",
    "  Gut:     'Mehrere Sozialreformen stehen zur Debatte'",
