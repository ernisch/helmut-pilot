...
const ministerienQuellenbindung = require("./ministerien-quellenbindung");
...
function buildUnderstandingPrompt(cluster = {}, opts = {}) {
  ...
  return [
    ...
    ...quellenRegeln,
    ...ministerienQuellenbindung.PROMPT_REGELN,
...
async function understandOneCluster(cluster, deps, opts = {}) {
  ...
  const quellenbeleg = ministerienQuellenbindung.pruefeMinisterienQuellenbindung(aiResult, modellPrompt);
...
async function evaluateUnderstandingCase(caseObj = {}, requestUnderstanding) {
  ...
  const validation = validateKnowledgeObject(ko);
  const quellenbeleg = ministerienQuellenbindung.pruefeMinisterienQuellenbindung(aiResult, prompt);
  validation.valid = validation.valid && quellenbeleg.valid;
  validation.errors = [...quellenbeleg.errors, ...validation.errors];
