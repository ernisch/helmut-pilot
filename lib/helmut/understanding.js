...
function buildUnderstandingPrompt(cluster = {}, opts = {}) {
  ...
  return [
    ...
    // Vollstaendige Rohantwort 19.09.: trotz offener Sachgrundlage wurden
    // Chancen ergaenzt. Pflicht zur Feldpraesenz ist keine Pflicht zur Deutung.
    "BELEGSTATUS DER ANALYSEFELDER:",
    "- warum_wichtig: Nur eine im gelieferten Text begruendete Bedeutung nennen. Fehlt sie, 'Politische Bedeutung ist aus den gelieferten Quellen nicht ableitbar.' Keine moeglichen Folgen erfinden, um das Pflichtfeld zu fuellen.",
    "- wer_ist_betroffen: Nur im Text belegte Betroffenheit mit ihrer Zuschreibung nennen. Fehlt sie, 'Betroffene Akteure sind aus den gelieferten Quellen nicht ableitbar.' Keine typischen Empfaenger, Zustaendigen oder Interessengruppen ergaenzen.",
    "- risiken und chancen: Ein Eintrag braucht eine im gelieferten Text beschriebene konkrete Folge und ihren Bezug zum dort belegten Akteur oder Gegenstand. Allgemeine Plausibilitaet ist kein Beleg. Ohne solche Folge bleibt die jeweilige Liste [].",
    "- Auch als 'moeglich', 'potenziell', 'koennte' oder als Bedingung formulierte Folgen brauchen diese Grundlage. Diese Woerter erhalten einen gelieferten Vorbehalt; sie erlauben keine neuen Folgen.",
    "- Weder ein Geldbetrag noch ein Institutionsname, ein Sachgebietslabel oder eine Ereignisart allein belegt eine bestimmte Folge. Die Art einer unklaren Leistung bleibt offen.",
    "- Fehlende Bedeutung, Betroffenheit oder Folgen nicht in why_relevant, recommendation oder andere Felder verlagern. Ohne ableitbare Handlungsoption bleibt recommendation leer; handlungsempfehlung nennt dann nur die oben festgelegte fehlende Grundlage.",
    "- Explizit gelieferte Folgen mit ihrer Zuschreibung, Bedingung und Unsicherheit konkret erhalten. Keine pauschale Ablehnung belegter Risiken, Chancen oder betroffener Akteure.",
    "",
