...
function validateUnderstandingResult(ko, aiResult, prompt) {
  ...
  return {
    ...
    errors: [...quellenbeleg.errors, ...(ebenenKonflikt ? ["decision_level-antwortkonflikt"] : []), ...schema.errors]
  };
}
...
async function understandOneCluster(cluster, deps, opts = {}) {
  ...
  if (!validation.valid) {
    ...
    return { vorgangId, status: "skipped-invalid", reason: "validierung-fehlgeschlagen",
      errors: validation.errors.slice(0, 5), documents: clusterDocs.length, ...spur, ...marke() };
  }
