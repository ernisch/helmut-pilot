...
function buildUnderstandingPrompt(cluster = {}) {
  ...
  return [
    ...
    "",
    "QUALITAET handlungsempfehlung (zwingend einhalten):",
    "- EIN konkreter naechster Schritt, keine allgemeine Prozessfloskel.",
    "- Falsch (zu allgemein): 'Position vorbereiten.', 'Linie abstimmen.', 'Haltung pruefen.'",
    "- Richtig (konkret): benenne die Handlung UND ihren Gegenstand, z. B. 'Kleine Anfrage zu den Kontrollmechanismen stellen.', 'Im Ausschuss nach dem Zeitplan fuer die Verordnung fragen.'",
    "",
