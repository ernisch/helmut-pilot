...
async function understandOneCluster(cluster, deps, opts = {}) {
  ...
  let aiResult;
  try {
    aiResult = await deps.requestUnderstanding(kontextEingabe ? kontextEingabe.prompt : buildUnderstandingPrompt(cluster));
  } catch (error) {
...
async function understandUpdate(cluster, deps, ctx = {}) {
  ...
  let aiResult;
  try {
    aiResult = await deps.requestUnderstanding(kontextEingabe ? kontextEingabe.prompt : buildUnderstandingPrompt(vollCluster));
  } catch (error) {
