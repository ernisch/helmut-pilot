...
function buildUnderstandingPrompt(cluster = {}, opts = {}) {
  ...
  // Nur expliziter Versuch. Kein Cron oder regulaerer Einstieg liefert diese Option;
...
async function understandOneCluster(cluster, deps, opts = {}) {
  ...
  // Nur der explizite Versuch kopiert; regulaere Aufrufer bleiben unveraendert.
  if (Object.hasOwn(kontextOption, "artikelkontextVersuch")) cluster = structuredClone(cluster);
...
async function understandUpdate(cluster, deps, ctx = {}) {
  ...
  const vollCluster = { documents: Object.hasOwn(kontextOption, "artikelkontextVersuch")
