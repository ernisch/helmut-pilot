...
async function resolveVorgang(cluster, deps, opts = {}) {
  ...
  if (typeof deps.getExisting === "function") {
    let exakt = null;
    try { exakt = await deps.getExisting(vorschlag); }
    catch (e) { try { console.error("[understanding] getExisting (exakter Kandidat) fehlgeschlagen:", e && e.message); } catch (_) { /* ignore */ } }
...
async function understandOneCluster(cluster, deps, opts = {}) {
  ...
  if (aufloesung.resolution === "bestand-lesefehler") {
    return {
      ...
      begruendung: "bestandslesefehler", lesefehler: aufloesung.lesefehler || null,
