...
// cleanEntry(value, Infinity) normalisiert (Whitespace/Trim) OHNE zu kappen --
// die Laengenpruefung selbst entscheidet hier bewusst zwischen "behalten" und
// "verwerfen", nicht "abschneiden".
function sanitizeDisplayTitle(value) {
  const v = cleanEntry(value, Infinity);
  return v.length <= DISPLAY_TITLE_MAX ? v : "";
}
