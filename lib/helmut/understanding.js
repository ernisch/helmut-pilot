  ...
  if (existing) {
    ...
    if (existing.status !== "pending") {
      ...
      if (!neueDocs.length) {
        ...
        const vormerkungen = await leseUpdateVormerkungen(deps, opts.retriesCtx);
        if (vormerkungen && Object.prototype.hasOwnProperty.call(vormerkungen, vorgangId)) {
          const fehlversuche = Number(vormerkungen[vorgangId]) || 0;
          ...
          return understandUpdate(cluster, deps, {
            ...
            retriesCtx: opts.retriesCtx, wiederaufnahme: true
          });
        }
      ...
      return understandUpdate(cluster, deps, {
        ...
        alleDocs: [...bestandsDocs, ...neueDocs], retriesCtx: opts.retriesCtx
      });
    }
