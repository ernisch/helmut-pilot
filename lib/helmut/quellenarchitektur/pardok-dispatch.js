...
async function pardokDispatch(source = {}, opts = {}) {
  ...
  try {
    ...
    // Eine vor dem Socket bestimmte Provider-Vertagung muss bis zur Queue
    // erhalten bleiben. Als normaler Shadow-Fetchfehler waere sie ein falscher
    // leerer Erfolg und wuerde einen Queue-Versuch verbrauchen.
    if (error && error.anbieterVertagung) throw error;
