...
function explainOnlyAlt(id, newIdSet, orphanClassification, consolidationBases) {
  // Explizite Karte des Aufrufers hat Vorrang; sonst neutrale Muster-Klassifikation.
  const klass = (orphanClassification && orphanClassification[id]) || classifyOrphanId(id);
