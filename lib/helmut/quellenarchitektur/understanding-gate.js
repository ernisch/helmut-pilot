...
const OFFICIAL_DOC_TYPES = new Set([
  ...
  // Roadmap-Punkt 24: drei REAL beobachtete Berliner PARDOK-Dokumenttypen, die bisher fehlten
  // (Struktur-Sonde 26.07.2026 gegen pardok-wp19.xml). Die Luecke bei "Schriftliche Anfrage" war
  // die gravierendste: das wichtigste Instrument des Abgeordnetenhauses fiel aus der amtlichen
  // Erkennung heraus und landete im Stichwort-/Alterspfad (gemessen: `parken`, Grund `zu-alt`).
  // Rein additiv und rueckwaertskompatibel: keiner der drei Werte kommt in den aktiven
  // Bundesquellen vor (gegen die reale Production-Stichprobe geprueft).
