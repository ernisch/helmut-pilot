...
function isGoogleNewsUrl(url) {
  return /(^|\.)news\.google\.com/i.test(canonicalDomain(url) || "") || /news\.google\.com/i.test(String(url || ""));
}

// --- Abrufweg-Methode klassifizieren ----------------------------------------
// Entscheidet nach der TATSAECHLICHEN URL, nicht nach der Fabrik: cem-ince-news nutzt zwar
