...
function sammleGeografieKandidaten(ko = {}, ai = {}, opts = {}) {
  ...
  //    Institution aus dem kanonischen Entitaetenkatalog. "Abgeordnetenhaus von
  //    Berlin" ist ein Beleg fuer Berlin — die blosse Ortsnennung "Berlin" ist
  //    es ausdruecklich NICHT (Regel 5).
  for (const ent of [...buildDecisionEntities(ko), ...buildRelatedEntities(ko)]) {
    const g = subnationaleGeografieVonEntitaet(ent.entity_id);
