...
const WBSB_KANDIDATEN = [
  ...
  {
    key: "bbsr-rss", publisher: "Bundesinstitut für Bau-, Stadt- und Raumforschung",
    domain: "bbsr.bund.de", quellenrolle: "RSS-Newsfeed-Übersicht (Meldungs-Feeds nach Themen: Raum-/Stadtentwicklung, Wohnungsmärkte, Bauen)",
    url: "https://www.bbsr.bund.de/BBSR/DE/Service/RSS/rssnewsfeed_node.html",
    method: "rss", retrieval_type: "rss", update_character: "laufend",
    fachliche_begruendung: "Ressortforschung des Bundes zu Wohnungsmarkt/Stadtentwicklung/Raumordnung — Frühindikator für fachliche Entwicklungen und Datenveröffentlichungen.",
    dubletten_hinweis: "keine",
    aufnahme_absicht: "pflichtkern"
  },
  {
    key: "bbsr-neue-veroeffentlichungen", publisher: "Bundesinstitut für Bau-, Stadt- und Raumforschung",
    domain: "bbsr.bund.de", quellenrolle: "Neue Veröffentlichungen (fortlaufende Liste neu erschienener BBSR-Publikationen)",
    url: "https://www.bbsr.bund.de/BBSR/DE/Aktuell/NeueVeroeffentlichungen/neueveroeffentlichungen_node.html",
    method: "html", retrieval_type: "html_liste", update_character: "laufend",
    fachliche_begruendung: "Laufende Publikationsliste des BBSR (Wohnungs- und Immobilienmärkte, Städtebau, Raumbeobachtung).",
    dubletten_hinweis: "Überschneidung mit bbsr-rss möglich",
    aufnahme_absicht: "pflichtkern"
  },
  {
    key: "bbsr-aktuell", publisher: "Bundesinstitut für Bau-, Stadt- und Raumforschung",
    domain: "bbsr.bund.de", quellenrolle: "Aktuelles/Meldungen-Überblick",
    url: "https://www.bbsr.bund.de/BBSR/DE/Aktuell/aktuell.html",
    method: "html", retrieval_type: "html_liste", update_character: "laufend",
    fachliche_begruendung: "Aktuelle Meldungen der Ressortforschungseinrichtung.",
    dubletten_hinweis: "Überschneidung mit bbsr-neue-veroeffentlichungen möglich",
    aufnahme_absicht: "referenz"
  },
  ...
  },
  {
    ...
    domain: "destatis.de", quellenrolle: "GENESIS-Online API/Webservice (Beschreibung/Zugang, maschinelle Abfrage der Bau-/Wohn-Tabellen)",
    url: "https://www.destatis.de/DE/Service/OpenData/genesis-api-webservice-oberflaeche.html",
    method: "html", retrieval_type: "api", update_character: "laufend",
    fachliche_begruendung: "Maschineller Zugang zu den amtlichen Bau-/Wohnungs-Zeitreihen (GENESIS) — spätere strukturierte Anbindung möglich.",
    dubletten_hinweis: "Beschreibungsseite; REST-Basis-URL nicht per Suche belegt (nicht erfunden)",
    aufnahme_absicht: "referenz"
  },
