...
// Institutioneller Ausschuss-Abrufweg? Die staendigen Ausschuesse heissen im Katalog immer
// "Ausschuss <Fachgebiet>"; die Themen-x-Kontext-Buendel tragen denselben type "committee",
// heissen aber "<Thema> · Ausschuss …". Deshalb Verankerung am Namensanfang.
function isInstitutionellerAusschuss(source = {}) {
  return String(source.type || "") === "committee" && /^Ausschuss /.test(String(source.name || ""));
}
