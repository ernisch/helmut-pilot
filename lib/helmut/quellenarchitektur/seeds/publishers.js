...
const DOMAIN_PUBLISHERS = {
  ...
  // Offizielle Landes-Institutionen Berlin/Brandenburg (Landtag-Sprint P2-5):
  // additiv — macht die Publisher-/Offiziell-Erkennung (radarState.publisherTypeForUrl,
  // isOfficialPrimarySource) landtagsfaehig. Heute crawlt keine dieser Domains
  // (Landesmodul-Gate + prepared-Pakete); die Eintraege sind inert, bis eine
  // Landesfreigabe erfolgt. Namen identisch zu seeds/landesmodule-quellen.js.
  "parlament-berlin.de": { name: "Abgeordnetenhaus von Berlin", entity_id: "parliament-berlin-agh", type: "parliament" },
  "pardok.parlament-berlin.de": { name: "Abgeordnetenhaus von Berlin", entity_id: "parliament-berlin-agh", type: "parliament" },
  "berlin.de": { name: "Land Berlin — Landespressedienst", entity_id: "government-berlin-senat", type: "government" },
  "landtag.brandenburg.de": { name: "Landtag Brandenburg", entity_id: "parliament-brandenburg-landtag", type: "parliament" },
  "parlamentsdokumentation.brandenburg.de": { name: "Landtag Brandenburg — Parlamentsdokumentation (parldok)", entity_id: "parliament-brandenburg-landtag", type: "parliament" },
  "landesregierung-brandenburg.de": { name: "Landesregierung Brandenburg", entity_id: "government-brandenburg", type: "government" },
  "stk.brandenburg.de": { name: "Staatskanzlei Brandenburg", entity_id: "government-brandenburg", type: "government" },
  "brandenburg.de": { name: "Ministerien Brandenburg", type: "ministry" },
  "statistik-berlin-brandenburg.de": { name: "Amt für Statistik Berlin-Brandenburg", entity_id: "statoffice-berlin-brandenburg", type: "statistical_office" },

  // Regionale Medien Berlin/Brandenburg (Landtag-Sprint P2-5, additiv/inert wie oben)
  "berliner-zeitung.de": { name: "Berliner Zeitung", type: "media" },
  "morgenpost.de": { name: "Berliner Morgenpost", type: "media" },
  "maz-online.de": { name: "Märkische Allgemeine", type: "media" },
  "moz.de": { name: "Märkische Oderzeitung", type: "media" },
  "lr-online.de": { name: "Lausitzer Rundschau", type: "media" },
