...
// Das `readiness`-Feld hier bleibt die RECHERCHE-Ebene (`kandidat`). Die ECHTE byte-genaue
// Verifikation (Sprint 9B, 2026-07-14, GitHub-Actions-Runner mit offenem Egress) ist als
// eigene, DATIERTE Ebene in `landesmodule-verifikation.js` gefuehrt (LIVE_URTEILE je Weg:
// geeignet / geeignet mit Einschränkung / ablehnen / nicht_verifizierbar). Eine Klasse wird
// erst zu `verifiziert`/`bereit` befoerdert, wenn ihr Weg real `geeignet` ist UND — bei den
// `ablehnen`-Wegen — die noetige URL-Korrektur (Feed-Deep-Link) erfolgt ist. Berlin/Brandenburg
// sind Kandidaten-abgedeckt, aber NICHT einsatzbereit (kein prepared-Eintrag in Production).
//
...
const BERLIN_KANDIDATEN = [
  { klasse: "landesparlament", publisher: "Abgeordnetenhaus von Berlin", domain: "parlament-berlin.de", url: "https://news.google.com/rss/search?q=site:parlament-berlin.de&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "niedrig", duplicateRisk: "niedrig", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "empfohlen", readiness: "kandidat", verifyBeforeActivation: true, note: "RSS-Feed-Hub; konkreten „Aktuelle Pressemitteilungen\"-Feed extrahieren. Bot-403 -> realistischer UA noetig. [9B-R2: googlenews-Ersatz site:parlament-berlin.de (kein Direkt-Feed auffindbar)]" },
  ...
  { klasse: "ausschuesse", publisher: "Abgeordnetenhaus von Berlin", domain: "parlament-berlin.de", url: "https://news.google.com/rss/search?q=site:parlament-berlin.de&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "mittel", duplicateRisk: "mittel", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "empfohlen", readiness: "kandidat", verifyBeforeActivation: true, note: "Ausschuss-Material-RSS am Feed-Hub + Ausschussprotokolle aus PARDOK-XML. Konkrete Feed-URLs je Ausschuss fixieren. [9B-R2: googlenews-Ersatz site:parlament-berlin.de (dedup mit landesparlament)]" },
  ...
  { klasse: "landesregierung", publisher: "Land Berlin — Landespressedienst", domain: "berlin.de", url: "https://news.google.com/rss/search?q=Senat%20Berlin%20site:berlin.de&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "niedrig", duplicateRisk: "hoch", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: true, cost: "offen", recommendation: "empfohlen", readiness: "kandidat", verifyBeforeActivation: true, note: "LPD-Gesamtfeed (index/feed) deckt Senatskanzlei + alle Senatsverwaltungen ab -> Oberklasse von 8/9. Institutionsfilter statt Mehrfach-Crawl. [9B-R2: googlenews-Ersatz Senat site:berlin.de (LPD-Basisfeed war leer)]" },
  { klasse: "staatskanzlei", publisher: "Senatskanzlei / Reg. Bürgermeister", domain: "berlin.de", url: "https://news.google.com/rss/search?q=Regierender%20B%C3%BCrgermeister%20Berlin%20Senatskanzlei&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "niedrig", duplicateRisk: "hoch", evidenceRole: "official_primary", produktnutzen: "mittel", stabileAdresse: false, cost: "offen", recommendation: "mit_einschraenkung", readiness: "kandidat", verifyBeforeActivation: true, note: "Gefilterte Sicht (institutions[]) des LPD-Gesamtfeeds — Teilmenge von 7, nicht separat crawlen. Exakten Institutionsnamen verifizieren. [9B-R2: echter RBm-Sektionsfeed statt veraltetem institutions-Filter]" },
  { klasse: "ministerien", publisher: "Senatsverwaltungen Berlin", domain: "berlin.de", url: "https://news.google.com/rss/search?q=Senat%20Berlin%20site:berlin.de&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "niedrig", duplicateRisk: "hoch", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "mit_einschraenkung", readiness: "kandidat", verifyBeforeActivation: true, note: "Je Senatsverwaltung als institutions[]-Filter des LPD-Feeds (NICHT berlin.de/sen/ — das ist ein Verzeichnis, kein Feed). Teilmenge von 7. [9B-R2: googlenews-Ersatz Senat site:berlin.de (dedup mit landesregierung)]" },
  { klasse: "landesfraktionen", publisher: "Fraktionen im Abgeordnetenhaus (CDU/SPD/Grüne/Linke/AfD)", domain: "parlament-berlin.de", url: "https://news.google.com/rss/search?q=%22Abgeordnetenhaus%20Berlin%22%20Fraktion&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "mittel", duplicateRisk: "mittel", evidenceRole: "direct_interest", produktnutzen: "mittel", stabileAdresse: false, cost: "offen", recommendation: "mit_einschraenkung", readiness: "kandidat", verifyBeforeActivation: true, note: "„/das-parlament/fraktionen\" ist Landing (KEIN RSS) -> Buendel der 5 Einzel-Fraktions-Feeds noetig; Linke-Anteil dubliert Klasse 14. [9B-R2: googlenews-Ersatz AGH-Fraktionen]" },
...
const BRANDENBURG_KANDIDATEN = [
  { klasse: "landesparlament", publisher: "Landtag Brandenburg", domain: "landtag.brandenburg.de", url: "https://news.google.com/rss/search?q=site:landtag.brandenburg.de&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "niedrig", duplicateRisk: "niedrig", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "empfohlen", readiness: "kandidat", verifyBeforeActivation: true, note: "RSS-Infodienste-Hub (12411); konkreten „Aktuelles/Meldungen\"-Feed extrahieren. Bot-403 -> realistischer UA noetig. [9B-R2: googlenews-Ersatz site:landtag.brandenburg.de]" },
  ...
  { klasse: "ausschuesse", publisher: "Landtag Brandenburg", domain: "landtag.brandenburg.de", url: "https://news.google.com/rss/search?q=Landtag%20Brandenburg%20Ausschuss&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "mittel", duplicateRisk: "niedrig", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "empfohlen", readiness: "kandidat", verifyBeforeActivation: true, note: "Kein zentraler Sammelfeed — je Fachausschuss eigener Feed -> Aggregationsliste noetig. [9B-R2: googlenews-Ersatz Landtag-Ausschuesse (404 auf /de/ausschuesse)]" },
  ...
  { klasse: "landesregierung", publisher: "Landesregierung Brandenburg", domain: "landesregierung-brandenburg.de", url: "https://news.google.com/rss/search?q=Landesregierung%20Brandenburg&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "niedrig", duplicateRisk: "mittel", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "empfohlen", readiness: "kandidat", verifyBeforeActivation: true, note: "bbo_rss-Aggregat-Feed (list.php?page=bb_rss-Muster) aller Ressort-PM -> Oberklasse von 8/9. Exakte Aggregat-URL verifizieren. [9B-R2: echter bbo_rss-Feed (brandenburg.de Presseinformationen)]" },
  { klasse: "staatskanzlei", publisher: "Staatskanzlei Brandenburg", domain: "stk.brandenburg.de", url: "https://news.google.com/rss/search?q=Landesregierung%20Brandenburg&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "mittel", duplicateRisk: "hoch", evidenceRole: "official_primary", produktnutzen: "mittel", stabileAdresse: false, cost: "offen", recommendation: "mit_einschraenkung", readiness: "kandidat", verifyBeforeActivation: true, note: "Kein eigenstaendiger stk-Feed nachgewiesen; STK-PM laufen ueber das Landesregierungs-Aggregat (bbo_rss-Knoten) -> Teilmenge von 7. 9B-Korrektur: 'www.' entfernt (TLS-Zertifikat deckt nur *.brandenburg.de, nicht www.stk.brandenburg.de); echter Feed-Pfad weiter offen. [9B-R2: echter zentraler bbo_rss-Feed (deckt STK ab) — dedup mit landesregierung]" },
  { klasse: "ministerien", publisher: "Ministerien Brandenburg (MIL/MWFK/MIK/…)", domain: "brandenburg.de", url: "https://news.google.com/rss/search?q=Ministerium%20Brandenburg&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "mittel", duplicateRisk: "mittel", evidenceRole: "official_primary", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "mit_einschraenkung", readiness: "kandidat", verifyBeforeActivation: true, note: "bbo_rss je Haus (Content-ID pro Ministerium verschieden; MIL-Neu-CMS-Pfad weicht ab) -> konkrete Feed-Pfade einzeln fixieren. [9B-R2: echter bbo_rss-Feed (MWFK, Muster) statt HTML]" },
  { klasse: "landesfraktionen", publisher: "Landtagsfraktionen (SPD/AfD/CDU/BSW)", domain: "landtag.brandenburg.de", url: "https://news.google.com/rss/search?q=Landtag%20Brandenburg%20Fraktion&hl=de&gl=DE&ceid=DE:de", method: "googlenews_search", parserEffort: "mittel", duplicateRisk: "niedrig", evidenceRole: "direct_interest", produktnutzen: "hoch", stabileAdresse: false, cost: "offen", recommendation: "mit_einschraenkung", readiness: "kandidat", verifyBeforeActivation: true, note: "8. WP: NUR SPD/AfD/CDU/BSW (Linke/Gruene/BVB ausgeschieden). Hub ist HTML; RSS je Fraktion nicht garantiert -> einzeln pruefen. [9B-R2: googlenews-Ersatz Landtag-Fraktionen]" },
