...
const BRANDENBURG_KANDIDATEN = [
  ...
  { klasse: "staatskanzlei", publisher: "Staatskanzlei Brandenburg", domain: "stk.brandenburg.de", url: "https://stk.brandenburg.de/", method: "rss", parserEffort: "mittel", duplicateRisk: "hoch", evidenceRole: "official_primary", produktnutzen: "mittel", stabileAdresse: false, cost: "offen", recommendation: "mit_einschraenkung", readiness: "kandidat", verifyBeforeActivation: true, note: "Kein eigenstaendiger stk-Feed nachgewiesen; STK-PM laufen ueber das Landesregierungs-Aggregat (bbo_rss-Knoten) -> Teilmenge von 7. 9B-Korrektur: 'www.' entfernt (TLS-Zertifikat deckt nur *.brandenburg.de, nicht www.stk.brandenburg.de); echter Feed-Pfad weiter offen." },
