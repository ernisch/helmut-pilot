...
const LIVE_META = Object.freeze({
  datum: "2026-07-14", run: "29295849135", runErst: "29294900851", pr: 71,
  egressOffen: true, realGeprueft: 25, gesamt: 25,
  runner: "GitHub Actions ubuntu-latest (offener Egress)",
  hinweis: "Re-Run nach bb-staatskanzlei-URL-Fix (www entfernt): TLS-Fehler behoben, jetzt 25/25 erreicht."
});
...
const LIVE_URTEILE = Object.freeze({
  ...
  "bb-staatskanzlei":        { urteil: "ablehnen",                   http: 200, beleg: "www-Fix behob TLS: stk.brandenburg.de leitet auf HTML-CMS (www.brandenburg.de/de/staatskanzlei/…) — kein RSS" },
