...
// Landtag-Sprint Phase 5/6: Landes-Vollmodelle Berlin/Brandenburg (additiv; Ausschuesse ohne
// canonical_key -> der committee:<key>-Index bleibt exklusiv Bundestag, keine Kollision).
// Die Entitaeten sind damit fuer die Klassifikation per EXAKTEM Namen/Alias aufloesbar;
// aktiviert wird dadurch NICHTS (Entitaeten sind kein Crawl-Gegenstand).
const {
  BERLIN_AUSSCHUESSE, BERLIN_FRAKTIONEN, BERLIN_SENATSVERWALTUNGEN, BERLIN_BEHOERDEN
} = require("./landtag-berlin");
const {
  BRANDENBURG_AUSSCHUESSE, BRANDENBURG_FRAKTIONEN, BRANDENBURG_GRUPPEN,
  BRANDENBURG_MINISTERIEN, BRANDENBURG_BEHOERDEN
} = require("./landtag-brandenburg");

const LANDTAG_ENTITIES = [
  ...BERLIN_AUSSCHUESSE, ...BERLIN_FRAKTIONEN, ...BERLIN_SENATSVERWALTUNGEN, ...BERLIN_BEHOERDEN,
  ...BRANDENBURG_AUSSCHUESSE, ...BRANDENBURG_FRAKTIONEN, ...BRANDENBURG_GRUPPEN,
  ...BRANDENBURG_MINISTERIEN, ...BRANDENBURG_BEHOERDEN
];
