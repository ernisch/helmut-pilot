...
const MINISTRIES = [
  ...
  // Pilot wohnen-bauen-stadtentwicklung-bund (Sprint): zustaendiges Bundesressort.
  ["ministry-bmwsb", "Bundesministerium für Wohnen, Stadtentwicklung und Bauwesen", ["BMWSB", "Bundesbauministerium"]]
...
const AUTHORITIES = [
  ...
  // Pilot wohnen-bauen-stadtentwicklung-bund (Sprint): nachgeordnete Bundesbehoerde (Bau/Raumordnung)
  // + Ressortforschung (Bau-/Stadt-/Raumforschung) + Verkuendungsplattform des Bundes (Bundesgesetzblatt).
  e("authority-bbr", "authority", "Bundesamt für Bauwesen und Raumordnung", { level: "bund", geography_id: "geo-bund", aliases: ["BBR"] }),
  // BBSR: Ressortforschungseinrichtung IM BBR, aber eigenstaendiger Herausgeber/Entitaet
  // (Fachreview §2 — vom Auditor ausdruecklich vermisst; zentrale Wohnungsmarkt-/Stadt-/Raumforschung).
  e("authority-bbsr", "authority", "Bundesinstitut für Bau-, Stadt- und Raumforschung", { level: "bund", geography_id: "geo-bund", aliases: ["BBSR"] }),
  e("authority-bfj", "authority", "Bundesamt für Justiz", { level: "bund", geography_id: "geo-bund", aliases: ["BfJ", "Verkündungsplattform des Bundes"] }),
