...
function promote(record, targetState, opts = {}) {
  ...
  // Eligibility-Pruefung fuer JEDEN serveable Zielzustand (active UND restricted) — auch eine
  // 'restricted'-Quelle wird ausgeliefert und darf nicht ohne Lizenz/Datenschutz/Freigabe dorthin
  // (Review-Fund: zuvor nur fuer 'active' geprueft).
  if (model.SERVEABLE_STATES.includes(targetState)) {
