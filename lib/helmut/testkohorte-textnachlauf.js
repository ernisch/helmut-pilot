...
async function ausfuehren({ commit, runId, confirmation, config,
  ...
  try {
    ...
    vorher = await storage.listRenderedBriefingsV3ForTenants(ids, ["lage"], day);
    ...
    const texts = await storage.listRenderedBriefingsV3ForTenants(ids, ["lage"], day);
...
module.exports = { ausfuehren, pruefeKosten, pruefeConfig, CONFIRM, PROCESS, BUDGET_MS, RESERVE_MS };
