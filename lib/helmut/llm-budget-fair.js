...
// gilt unveraendert dieselbe Grundordnung (Streuwert) und dieselbe wandernde
// Rotation — die synthetische Kohorte rotiert also weiterhin gegen sich selbst
// und verhungert nicht.
//
...
function rotationsReihenfolge(mandatsIds = [], tag = null, schritt = 1) {
  ...
  return [
    ...ordneEineKlasse(klassen.real, tag, schritt),
    ...ordneEineKlasse(klassen.synthetisch, tag, schritt)
  ];
}
