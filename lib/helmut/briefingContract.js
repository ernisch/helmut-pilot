...
function buildCurrentHelmutState({ profile = {}, decisions = [], kosById = {}, sourcesByVorgang = {}, now = new Date(), tenantId = null, briefingType = "daily" } = {}) {
  ...
  const meta = { generatedAt, briefingType, profileId, tenantId: tid };
...
function toBriefingContractV3({ profile = {}, decisions = [], kosById = {}, sourcesByVorgang = {}, now = new Date(), reason = null } = {}) {
  ...
  return {
    ...
    currentHelmutState: buildCurrentHelmutState({ profile, decisions: ordered, kosById, sourcesByVorgang, now: nowDate }),
