...
function istGlobalerCallType(callType) {
  ...
  return GLOBALE_CALLTYPES.has(ct) || ct.startsWith("understanding-");
}
...
function abgleichReservierung(zaehlerUsed, summe) {
  ...
  const protokolliert = summe ? summe.gemessen + summe.kostenUnbekannt : null;
