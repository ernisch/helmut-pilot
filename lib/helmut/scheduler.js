...
const { googleHardeningConfig, createGoogleNewsGate, evaluateCooldown } = require("./google-news-hardening");
...
const { sourceMode, buildRelationalCrawlPlan, mergeProfileAndPlanSources, dedupeSourcesById, buildShadowRunReport } = require("./quellenarchitektur/source-mode");
...
async function runSourceCrawl(politicianId, options = {}) {
  ...
  try {
    ...
    const crawl = await crawlAllSources(selectedSources, { googleGate, cooldown, hardeningConfig: hardening });
