...
function appointmentValue(value, fallback) {
  ...
  // Fallback-Termine (Pilot-Profilvorgabe) unterliegen derselben Stand-Regel wie
  // echte Termine: ein abgelaufener Beispieltermin darf nie als aktueller
  // Mandatstermin im Profil-Formular auftauchen.
  return (fallback || []).filter((entry) => !isPastAppointment(entry));
}
