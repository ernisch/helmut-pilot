...
**Wirkung:** Die bestehende Ämterprüfung hält auch unbelegte Parlamentsämter zurück. Gleicher lokaler Lesestand20 auf19 Karten, nur die fehlerhafte Karte entfällt, gespeicherte Daten unverändert. SQL20:40:34UTC read_only=on:504 Profile,5 aktiv,495 synthetisch alle inaktiv,505 Identitäten;0 aktive Sperren, Leases, verwaiste Jobs und junge Prozesse. Reiner Abschlussnachtrag auf `codex/402-production-abschluss-20260914`, keine neue Fachänderung. Sprintzustand teilweise abgeschlossen; Gesamtinhalt blockiert.
