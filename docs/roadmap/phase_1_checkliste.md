...
**Letzte Prüfung:** 2026-07-28 (Punkte 20, 21, 22 aktualisiert) · **`main`:** `1226232` (Merge #160) ·
...
| 23 | Matching | Matching-Ergebnisse dauerhaft nachvollziehbar machen | ⏳ | Es ist nachvollziehbar, warum ein Vorgang zu einem Profil passt | **Sprint 23A (2026-07-28) abgeschlossen:** Ist-Zustand vollständig verifiziert, Architekturentscheidung für 23B getroffen (Variante B+). Belegt: `matching_results` überschreibt bei jedem Lauf, kennt weder Lauf-ID noch Profil-/Vorgangsstand noch Rezeptversion; 78,4 % der Zeilen ohne jedes erklärende Merkmal; Briefings verweisen auf kein Ergebnis. **Offen: 23B** (Persistenz, freigabepflichtige Migration) und **23C** (sichtbare Erklärung). Kanonisch: [`../matching-nachvollziehbarkeit.md`](../matching-nachvollziehbarkeit.md) |
