...
| 22 | Daten | Embeddings vollständig speichern und prüfen | ⏳ | Relevante Wissensobjekte besitzen dauerhafte Embeddings | **Sprint 22A (2026-07-28): Architektur bewiesen und geprüft.** Wörtlich ist das Kriterium für den **Merkmalsvektor** erfüllt (772/772 verstandene mit dauerhaftem Vektor, 0 Defekte, Reproduzierbarkeit belegt) — der Punkt bleibt ⏳, weil „Embedding" hier ein deterministischer Merkmalsvektor ist, **kein** semantisches Embedding, und die Produktentscheidung dazu aussteht (Sprint 22B, Shadow-Vergleich). Kanonisch: [`embedding-architektur.md`](../embedding-architektur.md). **Nicht** mit OP-22 (Scoring) verwechseln |
