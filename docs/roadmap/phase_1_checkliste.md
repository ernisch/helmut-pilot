...
- **Offen extern:** die Ausschuss-Sollmenge einmal direkt gegen den Volltext der Drucksache 21/150 abgleichen — `bundestag.de`/`dserver.bundestag.de` sind aus der Agentensitzung nicht erreichbar (`403` auf `CONNECT`); die 24 Bezeichnungen stammen aus amtlichen Ausschuss-Tagesordnungen der 21. WP.
