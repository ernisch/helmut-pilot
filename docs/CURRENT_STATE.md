...
**Stand 09.09.2026: teilweise abgeschlossen.** PR #346 wurde mit ausdruecklicher Mergefreigabe als `15c5800bfa13a9e8b54078502b95c4c9b8c19797` uebernommen; Production READY `dpl_55wyybxzpdBPwKYghx5gRQHdi6KA` am Hauptalias frisch bestaetigt. PR Kopf `29e55f4bdd9e99f588f1c4526d3144445a334fa5`, Codebaum `b19fc5b18cbc64312f9732399c12e767ca29ded1`, CI `34353806977`: 344/344 Offline Suiten, 50 Browserpruefungen, 11 PostgreSQL Kontoschutzgruppen, 48 Z22 Datenbankpruefungen bestanden. Der Merge hat kein neues 500er Testfenster gestartet. PR #345 bleibt der getrennte historische Abschlussnachtrag.

**Aktuelle gezielte Fortsetzung:** Branch `codex/500-kostenfenster-20260909` ergaenzt die vor HTTP atomar reservierte Geldgrenze von 4 USD je UTC Tag im bestehenden gesperrten Production Testmodus. Historischer Tagesverbrauch und regulaere Textmodellaufrufe zaehlen mit; maximal 1000 manuelle Modellversuche in sechs Stunden, ohne automatische Wiederholung. [Technischer Vertrag und Testweg](betrieb/500-kostenbremse-2026-09-09.md). Diese Ergaenzung ist hier noch nicht deployt. Eine konkrete Freigabe des neuen bezahlten Fensters folgt erst nach bestandenem Kostenbeweis.
