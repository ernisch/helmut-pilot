...
**17.09.2026: PR419 bis PR425 offen, Draft, ungemergt; alle sieben GitHub CI Laeufe erfolgreich. Anschliessend freigegebener lokaler Artikelkontext vorbereitet: Ein Quellenabsatz erreicht im ausdruecklichen Versuch den Prompt;123 regulaere Originalprompts bleiben bytegleich. Gipfelfehler fachlich weiterhin offen. Kein Merge und keine Production Wirkung.**
...
**Freigegebene lokale Fortsetzung:** Branch `codex/artikelkontext-lokal-20260917`, exakt auf PR425. Nach Betreiber Go ein expliziter Artikelkontext mit maximal600 Zeichen vorbereitet. Dokumentkennung, Quellenstandhash, Artikeladresse, Titel, Absatzposition und Lesezeit binden den Zusatz. Privater Originalversuch:390 Zeichen Abschlussabsatz neben unveraendertem201 Zeichen Auszug; eine Quelle bleibt eine Quelle.123 normale Prompts bytegleich. Zehn neue Pruefgruppen und gezielte Regressionen erfolgreich. Lokal400/400 in682s, danach gezielte erfolgreiche Nachpruefung der Begrenzung auf eine direkt gesetzte Option samt Originalreplay. Keine automatische Quellenversorgung, Speicherung oder Modellaufrufe. Regeln sind artikelunabhaengig, regulaere Aufrufer nutzen den Zusatz nicht. **Gipfelfehler und allgemeine zukuenftige Inhaltsqualitaet nicht behoben.** Finaler Head und unabhaengige CI im zugehoerigen Draft PR. [Lokaler Vertrag, Pruefung und naechster Schritt](betrieb/gipfel-quellenluecke-2026-09-17.md#freigegebener-lokaler-artikelkontext).
...
Die Reparaturkette ungemergt pruefen lassen. Lokaler Gipfelversuch liefert jetzt zusaetzlichen Originalkontext, aber keine neue Modellantwort. Naechster Entscheidungspunkt: dauerhaft nachvollziehbare Herkunft und begrenzte Versorgung dieses Kontexts fuer regulaere Aufrufer; keine Artikelsonderregel. Nach dem Sprint unterscheiden, welche Motorregeln kuenftige Eingaben schuetzen und welche nur lokal vorbereitet sind. Gespeicherte Altvermischungen, Ereigniszeit, fachliche Aussagen und Profilbezug bleiben offen. Versorgungskapazitaet, Fortsetzungsplanung und sicheres Testende vor erneutem500er Nachweis klaeren. Keine Startfreigabe aus dieser Codearbeit ableiten.
