...
- **Offen:** Arm-PR CI/Merge, danach PR-C (Drain-Bilanz)/PR-D (Dedup-Fenster: PostgREST-1.000er-Kappe = bestehender Production-Fehler, effektiv ~2,9 statt 14 Tage), Gate-Flip als eigener Schritt, PR-B (48 Slots, `18,48 * * * *`), Deckel-Stufen 400/500/650/≤1.400 + Testkohorten 25/100/500 (Betreiberauftrag 31.08.; Zielarchitektur-Entwurf im Sitzungs-Scratchpad), OP-06 (1 769 Altfälle), Siebentagenachweis nicht begonnen.
