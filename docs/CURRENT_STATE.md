...
* **Roadmap26.09.: keine500er Startbereitschaft.** PR583/587–591/593 gemergt; letzter gelesener Production-Commit `daa57d9c`. 500 Profile/0 aktiv, keine offenen Jobs/Sperren/Kosten.18 Modellaufrufe:0,128230USD. Lokaler500er Readback: alle mit Briefing-Items, aber497 ohne Tagesprioritaet. Ein gespeicherter Lage-Text scheitert an der eigenen Zeitbezugspruefung. [Aktuelle Bilanz und verbleibende Startblocker](betrieb/vorstart-bilanz-20260926.md). [Dauerauftrag bis vor Aktivierung/Test](betrieb/autonom-bis-500-starttor-20260926.md).
