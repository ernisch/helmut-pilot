...
**Letzte Aktualisierung:** 2026-07-29 (**Sprint Roadmap-Punkt 24: Landtags-Parser Berlin/Brandenburg —
...
Drucksache · Kleine Anfrage · Sitzung + Vorgangsbezug. Nicht lieferbare Klassen sind als fachliche
Ausnahme hinterlegt und werden **nicht** simuliert. **Zwei Befunde:** **24-1** — das
...
verbindlich ist `content_hash` als PARDOK-Identität. Belegt aus dem echten Sondenlauf
...
**88/88**, **Mutationsprobe 7 von 7 rot**, Offline-Suite **182/182** unter CI-Bedingungen
(Ausgang 181/181), Browser-Smoke **32/32**. **0 KI-Aufrufe, 0,00 USD, keine Migration, kein Flag,
