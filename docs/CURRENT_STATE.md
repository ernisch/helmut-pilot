...
* **Roadmap26.09.: keine500er Startbereitschaft.** PR591–594 ausgerollt, Production `c22c9c1a` READY. Lesung06:24UTC:500 Profile/0 aktiv, keine offenen Jobs/Sperren/Kosten;0,133955USD. Lokaler500er Readback:497 ohne Tagesprioritaet; keine belegten Auswahlverluste. Der alte Lage-Text bleibt fachlich ungueltig. PR595 bereitet einen eigenen begrenzten Zeitnachweis vor. [Quellen-/Kostendiagnose](betrieb/lage-pruefquellen-20260926.md), [Vorstartbilanz](betrieb/vorstart-bilanz-20260926.md), [Dauerauftrag](betrieb/autonom-bis-500-starttor-20260926.md).
