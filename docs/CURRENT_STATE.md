...
Werkzeug-Härtung W-1+W-2 gemergt (#152) · **Phase B: Migration `20260727` angewendet
und verifiziert · Phase C: Flag aktiviert, Dual-Write-Smoke über den echten
Production-Pfad bestanden — offen nur noch der Nachweis an einem echten Cron-Lauf**) ·
**`main`-HEAD:** `54e9c12` (Merge #152)
