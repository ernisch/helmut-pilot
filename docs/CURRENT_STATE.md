...
**Getrennte Datumskorrektur:** `codex/500-belegtes-meldedatum-20260910` nutzt belegte Publikation vor Analyse fuer Auswahl/Status/Diagnose/Kopf und zeigt das Jahr. Metadaten und Fallback ohne Publikation erhalten. Vier echte Regressionen behoben, gezielt85/85,15/15,28/28,57/57. Einzige Gesamtsammlung75166 beendet346/348 in583s, nur zwei fehlende lokale Browser; CI muss final pruefen. Alte komplette Pakete werden dadurch noch nicht neu gespeichert. Zwei abgeschnittene Empfehlungen und eine jetzt belegte falsche Quellenzuordnung bleiben gesondert offen. [Belege und Grenzen](betrieb/500-kostenabbruch-2026-09-10.md).
