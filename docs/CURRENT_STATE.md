...
- **Tests:** **Offline-Gesamtlauf 308/308 grün in 694 s** (Exit 0) · **Browser-/Mobile-Smoke 32/0** · alle 14 Datenbankvertrags-Suiten grün. Neu: `mandatsklasse` 36/0, `verdraengungsschutz` 28/0, `llm-usage-relational` 37/0, `funktionstest-ablaufplan` 52/0; erweitert: `funktionstest-500` 108/0, `testkohorte-betrieb` 89/0, `minimal-cron` 39/0, `kapazitaetsmodell` 58/0, `cron-fairness` 285/0.
