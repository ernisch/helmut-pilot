...
**Stand: 09.09., 16:16 Tuerkei / 15:16 Berlin / 13:16 UTC. PR #346 NACH AUSDRUECKLICHER BETREIBERFREIGABE VEROEFFENTLICHT; 500ER FUNKTIONSNACHWEIS WEITER OFFEN.** main und Production zeigen `15c5800bfa13a9e8b54078502b95c4c9b8c19797`, READY `dpl_55wyybxzpdBPwKYghx5gRQHdi6KA`. Der reparierte manuelle Pfad ergaenzt aktuelle Profilauswahl, behaelt Alttexte mit voller Historie und setzt nach bekannten Quellenablehnungen andere Profile fort. Ein Merge erzeugt keine 500 Ergebnisse; kein weiterer Fachlauf oder neue Aktivierung aus dieser Freigabe abgeleitet. Nach Merge Wirkung rein lesend kontrolliert. Die neue vollstaendige Restliste und der Betriebsbericht sind separat fuer den Betreiber gesichert, ihre oeffentliche Uebertragung bleibt ohne Freigabe gesperrt. [Historischer Testabschluss](betrieb/500-testfenster-2026-09-09.md), [historische Einzeluebersicht](betrieb/500-testfenster-einzelpruefung-2026-09-09.json).

**Betreiberanweisung:** Alle Profile, einschliesslich der fuenf bisher als real bezeichneten, sind ungenutzte Testprofile. Ihr besonderer Verfuegbarkeitsvorrang entfaellt fuer diesen Sprint. Historische Schutzbeschreibungen unten sind insoweit ueberholt. Datenerhalt, Kosten und Ausschluss konkurrierender Laeufe bleiben verbindlich. Der neue reine Auswerter `scripts/500-restpruefung.js` prueft die komplette Zielmenge. Naechster Schritt: harte wirksame Kostengrenze und begrenztes Testfenster konkret vorbereiten; danach dessen erforderliche Freigabe. Merge #346 ist erledigt und wird nicht nochmals zur Freigabe gestellt.
...
* **[PR #346 Production](https://github.com/ernisch/helmut-pilot/pull/346):** Freigegebener Kopf `29e55f4bdd9e99f588f1c4526d3144445a334fa5`, Merge und READY oben. [CI 34353806977](https://github.com/ernisch/helmut-pilot/actions/runs/34353806977): 344/344 Suiten, Browser 50/50, Kontoschutz und Teilnahme 11/11, Z22 48/48. Baum `b19fc5b18cbc64312f9732399c12e767ca29ded1` in geprueftem Kopf und echtem Merge identisch. Der bestehende reine Dokumentations PR #345 wird um diesen belegten Abschluss ergaenzt; er enthaelt keine neue Fachkorrektur.
...
1. Merge und Production Veroeffentlichung von #346 sind ausdruecklich freigegeben, ausgefuehrt und unabhaengig gelesen. Den konkreten Nach Merge Stand in bestehendem Dokumentations PR #345 sichern. Kein neuer Production Erfolg aus CI ableiten.
2. Vor einem weiteren kostenpflichtigen Fachlauf feste Zielmenge, erwartete Modellaufrufe, Kostenschaetzung, harte wirksame Kostengrenze und Abbruchbedingungen festlegen. Das alte Fenster ist geschlossen. Kosten, konkurrierende Verarbeitung und unbekannte Speicherzustaende bleiben Stopps.
...
Neuester Auftrag: alleinige Uebernahme und vollstaendiger Nachweis fuer alle 500 Testprofile. Alle Profile sind ungenutzte Dummys. Merge #346 ist ausdruecklich freigegeben und ausgefuehrt; ein weiterer kostenpflichtiger Fachlauf noch nicht.
Die fruehere ausdrueckliche Grenze **kein Merge oder Production Deployment
ohne Freigabe** gilt fuer jede neue Aenderung. #342 und einzelner Kostennachtrag sind freigegeben und ausgefuehrt; keinen zweiten Kostennachtrag. Die genehmigte einmalige temporaere Teilnahme der 495 vorhandenen synthetischen Profile und der manuelle Fachlauf sind ausgefuehrt; das Fenster ist geschlossen. Kein besonderer Verfuegbarkeitsvorrang alter Dummyprofile. Identitaeten, Konten, Budgets, Umgebungsvariablen und Cron Ablaeufe bleiben unveraendert.
