...
- **Tests (alle über `scripts/lokal.js`):** neue Suite `lauf-bilanz-test.js` **104 PASS / 0 FAIL**; Offline gesamt **284/286** — die zwei roten sind fehlende lokale npm-Pakete (`ical.js`, `@aws-sdk/client-sqs`) außerhalb des Änderungssatzes.
