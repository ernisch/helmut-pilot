...
**Ueberholte 20.09.-Statuseintraege (Quellenreparaturen PR471–473, Personengruppenfix PR469, Zeitplaner PR467, Zwischenstand vor dem Timingabschluss, integrierte Reparaturen PR419–463, historischer Testabschluss laut Bericht vom16.09.) sind woertlich unveraendert archiviert:** [2026_09_22_statuskopf_vor_quellenvorlauf.md](archive/project_state/2026_09_22_statuskopf_vor_quellenvorlauf.md) · [2026_09_22_historische_statuseintraege.md](archive/project_state/2026_09_22_historische_statuseintraege.md).

**23.09.2026: Manueller Actions-Ausfuehrungsweg fuer den einmaligen 169er Verstehenslauf vorbereitet; NICHT ausgefuehrt.** Workflow `.github/workflows/verstehen-169-einmalig.yml`: nur `workflow_dispatch` auf main, exaktes Bestaetigungswort, `run_attempt=1`, `contents: read`, Concurrency `helmut-500-kontrollierte-facharbeit` (`cancel-in-progress:false`), Timeout 40 min, direkt `node scripts/verstehen-einmalig-169.js` (nicht `scripts/lokal.js`), GitHub-Secrets plus Azure-Deployment-Muster, fail-closed-Preflight, keine Secret-Ausgabe. **Kostenblocker geschlossen:** harter 0,80-USD-Laufdeckel ueber die bestehende atomare Kostenwahrheit (volle Reservierung je Aufruf plus echte Abrechnung, Laufkennung `verstehen169-…`) statt Durchschnittspreis; neue Pruefung `scripts/verstehen-169-kosten-deckel-test.js`. Grenzen unveraendert (169/122, 113, 0,80 USD, 35 min, 4-USD-Riegel). Statische Pruefung `scripts/verstehen-169-workflow-test.js`; Branch `codex/verstehen-169-actions-20260923`. **Kein Dispatch, kein Lauf; Start braucht Betreiberfreigabe.** [Beleg](betrieb/verstehen-einmalig-169-20260922.md).
