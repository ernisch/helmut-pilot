...
**Neue Inhaltsbelege:** FAZ Autobahnfinanzierung, Apotheken Umschau und VdK Rente erstmals vollständig lesbar; vier weitere Stellenanzeigen vollständig und eine teilweise gelesen. Heutige Herausgebertexte getrennt von historischer Aufnahme. Einzelne Rollen, Prognosen und Mandatsannahmen im privaten Entwurf korrigiert. Original30 und alle Eingaben erhalten. Echter finaler Aufbau30 Karten,0 Auslassungen,37 unveränderte ursprüngliche Quellenzeilen,345 gebundene Textstellen. 165 Textvarianten gelesen; keine vollständige Fachfreigabe.
