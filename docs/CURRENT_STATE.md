...
**17.09.2026: PR419 bis PR426 offen, Draft, ungemergt; alle acht GitHub CI Laeufe erfolgreich. Folgebranch bindet den expliziten Artikelkontext an Erstverstehen und Aktualisierung:123 normale Quellenlisten behalten in beiden Pfaden Prompt und Reservierungskennung. Automatische Kontextversorgung und Gipfelfehler bleiben offen. Kein Merge und keine Production Wirkung.**
...
**Folgeschritt Eingabebindung:** Branch `codex/artikelkontext-eingabebindung-20260917`, Basis exakt PR426. Beide Fachpfade reichen expliziten Kontext vorgeprueft weiter; der CAS Eingabehash bindet den festgehaltenen Prompt. Ohne Zusatz bleiben123 Erstverstehens und123 Aktualisierungseingaben bytegleich. Zehn neue Pruefgruppen, CAS107/107 und Restzeit52/52 erfolgreich. Lokal401/401 in664s, Exit0. Finaler Head und unabhaengiger CI Nachweis im zugehoerigen Draft PR. **Automatische Beschaffung, dauerhafte Herkunft und fachlich korrigierte Antwort bleiben offen.** Keine Route, Speicherung, Cron oder Modellaufrufe hinzugefuegt. [Ursache und Nachweise](betrieb/gipfel-quellenluecke-2026-09-17.md#bindung-an-die-verstehenseingabe).
...
Die Reparaturkette ungemergt pruefen lassen. Der explizite Gipfelkontext erreicht beide Verstehenspfade mit passender Eingabebindung, aber ohne neue Modellantwort. Naechster Schritt: Absatzwahl, dauerhafte Herkunft und begrenzte Beschaffung fuer regulaere Aufrufer konkret festlegen; die600 Zeichen Grenze garantiert keine ausreichende Textauswahl. Keine Artikelsonderregel und kein blosser Speicherhash als Herkunftsnachweis. Allgemeine Motorregeln und noch nicht angeschlossene Versorgung getrennt bewerten. Altvermischungen, Ereigniszeit, Aussagen und Profilbezug bleiben offen. Versorgungskapazitaet, Fortsetzungsplanung und sicheres Testende vor erneutem500er Nachweis klaeren. Keine Startfreigabe aus dieser Codearbeit ableiten.
