...
1. Appstartkorrektur #318 ist geprüft und ausgerollt (SR §51.3). Die Oberfläche lädt, der Datenbankzugang bleibt unbelegt. Nächster betrieblicher Schritt: Supabase Wiederanlauf mit eigener Freigabe vorbereiten; die verbundene App bietet keine Neustartfunktion. Nach erfolgreichem SQL zuerst Bestand, Kosten, Laufzustände und Kommunikationssperre frisch erheben. Keine weitere Mandatsaktivierung vor diesem Nachweis.
