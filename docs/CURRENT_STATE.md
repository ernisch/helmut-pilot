...
- **Offen:** §11 (echter PostgREST-Rückfallnachweis), die übrigen still überspringenden Datenbanksuiten, Z3b, Azure, Parserfix (PR #274) und die nächste natürliche Fünferprüfung. Der natürliche Fünferlauf vom 27.08. war wegen eines rohen Steuerzeichens im KI-Umschlag rot; die Fixes in PR #274 (KI-Umschlag, [Beleg](betrieb/ki-antwortumschlag-parserfix-2026-08-28.md)) und PR #275 (Planungszeitbudget, [Beleg](betrieb/planungs-zeitbudget-hardening-2026-08-28.md)) sind lokal grün, aber **ungemergt und nicht deployt** — in Production unbewiesen. Mergefolge #274 → #275.
