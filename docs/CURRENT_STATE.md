...
**Stand: 06.09.2026, 10:20 Türkei / 09:20 Berlin / 07:20 UTC.** **#306 gemergt**, `main` **`cfd18b2`**, Production erneut **READY**. Manueller Leselauf nach neuem Nutzerauftrag gestartet. **BLOCKIERT: Datenbankabruf über GitHub und direkten Lesezugang gestört; Vercel Konfigurationsprüfung deshalb übersprungen.** #307 trennt beide Leser und ergänzt sichere HTTP Statusnummern; noch nicht gemergt. Letzte Grundlinie 00:28 UTC: **29 Profile, 25 aktiv, vier inaktiv**, B/C und Löschmarken null. Morgenläufe, aktueller Bestand und Kosten ungeprüft. Ziel exakt 500 offen, §41 bleibt verbindlich. Nachweise: [SR §44.3](betrieb/500-funktionstest-sicherheitsrahmen-2026-09-01.md).
