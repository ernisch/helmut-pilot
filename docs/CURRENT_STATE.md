...
- **Tests:** Offline-Gesamtlauf grün; neu `mandatsklasse` 36/0, `verdraengungsschutz` 23/0, `llm-usage-relational` 35/0, `funktionstest-ablaufplan` 52/0; erweitert `funktionstest-500` 108/0, `testkohorte-betrieb` 89/0.
