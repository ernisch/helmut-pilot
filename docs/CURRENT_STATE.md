...
**Letzte Aktualisierung:** 2026-07-29 (**Roadmap-Punkt 24 ABGESCHLOSSEN — 3. Durchgang: der
...
Mutationsprobe **6 von 6 rot**, Offline-Suite **168/182 = Baseline auf `main`** (dieselben 14
DB-/netzgebundenen Suiten, **keine** durch diesen Sprint), Browser-Smoke **32/32**. **0 KI-Aufrufe,
