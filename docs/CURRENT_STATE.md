...
**Letzte Aktualisierung:** 2026-07-29 (**HOTFIX Aktualitätsfilter `matching_results` — aktiver
...
(**Sprint 23B-1: PR #169 gemergt (`b1d450c`) und Migration
...
nicht nötig. **`HELMUT_MATCHING_AUDIT` existiert weiterhin nicht in Vercel — die Auditpersistenz ist
noch nicht aktiv.** Sprint bleibt **teilweise abgeschlossen** bis zur getrennten Flag-Freigabe mit
kontrolliertem Production-Beweislauf. Details: [`matching-nachvollziehbarkeit.md`](matching-nachvollziehbarkeit.md)
§21.6.) ·
