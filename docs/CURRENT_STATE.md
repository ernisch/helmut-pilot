...
**14.09.2026: B055 Ausgabekonsistenz gezielt korrigiert, technische Abnahme läuft.** [Kanonischer Beleg](betrieb/500-lage-quellenfenster-2026-09-13.md#b055-ausgabekonsistenz-am-14092026). Ausgang main cdabf46784e091294161013d39488673efa3324d, PR398 gemergt; Production dpl_66sV2V7F6QziGLDoH53o4AHiwJMU READY mit richtigem Commit und Hauptalias. Vorhandene Main CI34871947272 inzwischen vollständig erfolgreich. Kein alter Lauf neu gestartet.

**Neue begrenzte Korrektur:** Explizit ignorierte Vorgänge erhalten in beiden Vertragslisten das Label Ignorieren und werden kein Hauptthema. Alle Karten bleiben erhalten; der tatsächliche leere Schwerpunkt sagt keine Entwarnung zu. Die private Entwurfsansicht zählt erst nach Quellenprüfung und unterscheidet zurückgehaltene von nicht angezeigten Entwürfen. Gegenfälle vor Korrektur rot, danach92/92 Zustandsprüfungen,10/10 Korrekturgruppen,31/31 Adapter und78/78 Schwerpunktprüfungen erfolgreich. Vollständige technische Vorprüfung und PR Abnahme stehen noch aus.

**Private Ausgabe:** gleicher aufgenommener Eingang,30 Kennungen,37 Quellenzeilen, keine Auslassung; Kartentexte und Quellen unverändert. Jetzt30 Labels Ignorieren und kein künstliches Leitthema. Historische Beleglücken, Haushaltsdoppelung und20 Karten ohne individuellen Profilauftrag bleiben fachlich offen. Ergänzende heutige Herausgebertexte sind getrennt gespeichert. Keine vollständige Inhalts oder Nutzenabnahme.

**Nächster Schritt ist nicht der500er Test:** technische Korrektur abnehmen, verbleibende Quellen unabhängig verfolgen und neue exakt gebundene Inhaltsabnahme schaffen. Danach belastbaren Urteilsweg und Testabschluss für500 nachweisen. Keine Production Datenänderung, Aktivierung oder Modelle. Neuer500er Sprint benötigt eigene ausdrückliche Startfreigabe. Hier weiter, Hoch.
