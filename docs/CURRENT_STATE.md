...
1. **Zugang:** GitHub Datenbankzugang im Lauf `33999766780` belegt; drei Secrets vorhanden, sieben geprüfte GitHub Betriebswerte fehlen. Neue rein lesende Laufzeitroute vorbereitet, 24 Tests grün; erst nach Merge und READY nutzen. Browser erlaubt manuelle Workflow Bedienung. Kohortenausführung weiter offen. Details SR §44.
...
1. GitHub Zugang ist belegt (SR §44). Nach Prüfung, Merge und READY die neue Laufzeitroute über den manuellen Workflow lesen; Checkout und bestätigten Production Commit identisch wählen. Danach geprüften Ausführer mit belegten Betriebswerten vorbereiten. Vor Fachläufen Grundlinie, Uhr, Prozesse, Kosten und Kommunikationsriegel frisch prüfen. Keine neue Vercel Anmeldung.
