...
Das ist **kein** Produktnachweis (`produktabnahme=false`,`inProductionImportiert=false`). Naechster Schritt: 36er Fachvertrag definieren (Fallauswahl, Erfolgswerte, Kostenobergrenze, Stoppbedingungen) vor weiteren bezahlten Aufrufen; danach frische500er Versorgung,1500 Positionen, Zeit/Kosten. Alle504 Profile bleiben inaktiv; 4 USD Riegel unveraendert.
