...
- **Migrationen:** OP-30-Dateien seit 15.08. angewendet; `20260823043633` seit 23.08. installiert (Doppelbuchung dokumentiert, Runbook §30.6). Auf `main`, aber **nicht in Production angewendet**, liegen `20260720`, F9 (`20260825101500`) sowie Z22 (`20260826190000`) mit der Vorwärtskorrektur `20260829123132`; der Anwendungscode fällt ohne Z22 auf das alte Verhalten zurück. Im isolierten Z3b-Testprojekt ist die alte Z22-Fassung unter `20260827121931` und die Korrektur unter der vom Supabase-Werkzeug erzeugten Buchung `20260829135455` angewendet (§18). Jede Production-Anwendung bleibt freigabepflichtig.
...
- Kein Merge nach `main` (= Deployment), kein Deployment, keine Production-Datenänderung, keine Secret-/Env-/Flag-/Cron-Änderung ohne ausdrückliche Freigabe. In Production offen sind `20260720`, F9 (`20260825101500`), Z22 (`20260826190000`) und dessen Vorwärtskorrektur (`20260829123132`). Der isolierte Testprojektbeleg erteilt keine Production-Freigabe.
...
**Teilweise abgeschlossen:** PR #273 ist als Merge `ae74a9bc` in `main` und automatisch deployt. **Keine Z22-Migration wurde auf Production angewendet.** Alle Zahlen und Prüfsummen: [`betrieb/z3-realistiknachweis-2026-08-26.md`](betrieb/z3-realistiknachweis-2026-08-26.md) §13 und §14.
