...
**Stand: 07.09.2026, 00:34 UTC. Sprint BLOCKIERT; Wiederanlauf und Lage 25/25 belegt.** main `69d2b604` aus #324, Production READY. Echte Vorrangreserve **200**, Deckel **2416**, Reserve **702** und Kommunikationssperre frisch gelesen. Supabase gesund, Bestand **29/25/4**. **A offen:** elf Aufträge; Tageszähler des 06.09. 92. Automatische Freigabeprüfung lehnte den neuen Fachlaufstart ab; kein neuer Fachlauf. Betreiberziel **nach dem bestehenden Test direkt auf 500**, Ausführungsweg noch anzupassen. [SR §53–§55](betrieb/500-funktionstest-sicherheitsrahmen-2026-09-01.md).
...
- **Aktueller Codekopf:** `69d2b6048726e5f70a6a423e9d4acfb1176c569b` aus [#324](https://github.com/ernisch/helmut-pilot/pull/324). Production `dpl_5pKLEFMXjkiznnFpcPeB2fEvPTaa` **READY** am exakten Kopf; **332/332** lokale Suiten, **40/40** Browser, beide PR und main Pflichtjobs grün (main CI `34069947355`). Reiner Production Leser `34070000477` erfolgreich. Dieser reine Abschlussnachtrag hat keinen neuen Code; eigener Merge und Deployment folgen aus der Historie.
...
1. **Azure Zugang und #322/#323/#324 erledigt.** Reiner Leser bestätigt echte Vorrangreserve 200, Budget und Kommunikation. Kein weiterer technischer Eingriff oder Azure Umbau dafür nötig.
2. Explizite Freigabe für einen neuen, auf **eine Pipeline Runde** begrenzten A Start klären. Erster Vorlauf `ausgeloest:false`; automatische Prüfung sperrte das erneute Absenden. Vor Start alle Tore frisch prüfen. Engeres A Startfenster: **00:36 bis vor 02:54 Türkei / 23:36 bis vor 01:54 Berlin / 21:36 bis vor 23:54 UTC**. Nächster Beginn nach diesem Nachtrag: **08.09., 00:36 Türkei / 07.09., 23:36 Berlin / 07.09., 21:36 UTC**, nur mit aktuellem natürlichen Abendcrawl und frischer Grundlinie. Keine automatische Wiederholung oder Umgehung.
