...
**17.09.2026: PR419 bis PR422 offen, Draft, ungemergt; alle vier GitHub CI Laeufe erfolgreich. PR422 behebt die belegte Kuerzung von Ersatztiteln. Fuenfter Folgebranch behandelt doppelte WELT Artikel und widerspruechliche Quellenzeiten. Kein Merge und keine Production Wirkung.**
...
**Fuenfter Reparaturteil:** Branch `codex/artikelidentitaet-20260917`, Basis PR422 `6528ecabb028fcfbdc97e1ed55c84f2bbc8dfc83`. Belegte WELT Artikelvarianten zaehlen in der Briefingprojektion einmal; alle Belegvarianten bleiben erhalten. Widerspruechliche Publikationszeiten werden nicht willkuerlich aufgeloest und nicht durch Analysezeit als frisch ausgegeben. Neue Suite11/11 und privater Replay erfolgreich: eine Karte samt Empfehlung korrigiert,21 weitere Karten und alle anderen Vertragsfelder identisch. Lokal398/398 in648s plus erfolgreiche gezielte Nachpruefungen der abschliessenden HTTPS Begrenzung. Kein offener lokaler Testfehler; finaler Head und GitHub CI im zugehoerigen Draft PR. Rohdaten und Altpakete unveraendert; fachlich richtiges Datum und Aussagen bleiben ungeprueft. [Ursache, Pruefungen und Grenzen](betrieb/artikelidentitaet-2026-09-17.md).
