...
1. #309/#310/#313 sind ausgerollt. Erst nach erfolgreicher Minimalabfrage Bestand, Modellkosten und Laufzustände frisch erheben. Speicherdruck ist ein Hinweis, keine belegte Ursache. Neustart und Ressourcenänderung bleiben gesondert freigabepflichtig. Allgemeiner Schutz geteilter Blobs zwischen mehreren Instanzen bleibt offen (§49).
