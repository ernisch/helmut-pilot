...
- **Bytegenaue amtliche Bestätigung war nicht möglich:** parlament-berlin.de, landtag.brandenburg.de und bundestag.de sind aus der Cloud-Sitzung per Egress-Proxy gesperrt (CONNECT 403 / EGRESS_BLOCKED, belegt 24.08.). Alle 20 Profile tragen den Vermerk „noch nicht bytegenau bestätigt"; die fehlenden Prüfungen sind je Profil im Paket und in der Entscheidungsvorlage aufgelistet. Frühere bytegenaue Verifikationen liefen über einen GitHub-Actions-Runner mit offenem Egress (Sprint 9B) — dieser Weg war in diesem Sprint ausdrücklich untersagt.
