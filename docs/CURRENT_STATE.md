...
1. Vorrang: Appstart bei Datenbankausfall korrigieren (`codex/app-start-datenbankausfall`, SR §51). 26 gezielte und 40 Browserprüfungen bestanden; vollständige Prüfung und Übernahme offen. #316 samt Abschluss #317 ist ausgerollt. Nach erfolgreichem SQL zuerst Bestand, Kosten, Laufzustände und Kommunikationssperre frisch erheben. Neustart und Ressourcenänderung bleiben gesondert freigabepflichtig.
