...
**21.09.2026: 8 Fall Sachpruefung BESTANDEN — Methode abgenommen, kein Produkt- oder 500er Nachweis.**
Main `52bbbc6d8968227cf07e2fc745a59856e42b99ed` (Merge PR502); Vercel Production fuer genau diesen Commit READY. PR493/496/497/498/499/500/501/502 integriert; PR495 offen und unangetastet.
Lauf35651115787 auf `codex/prosa-modellvergleich-satzfix-20260921`, Commit ee7b5ecb0d731c49883292af303d4af619420d9a: genau EIN Aufruf, gpt 5 mini,8000 Ausgabetokens,4397/2641 Token in23755ms, HTTP200, Ist Kosten0,012763 USD, Ticket `abgerechnet`; die zwei alten unbekannten Reserven blieben bytegleich gebunden. Kein Retry.
Ergebnis8 von8 Sollurteilen korrekt (6x widersprochen,2x tragfaehig),0 falsch positiv,0 falsch negativ, `methodenvergleichBestanden=true`. Der Vorlauf35643571975 scheiterte nur am Ordinaldatum Satzfehler; PR501/502 behoben ihn (vertragHash 7f24364b, paketHash 73a88aec).
Das ist **kein** Produktnachweis (`produktabnahme=false`,`inProductionImportiert=false`). Der 36er Fachvertrag ist konkretisiert ([eigene Datei](betrieb/prosa-36er-vertrag-2026-09-21.md)): 18 Fachfaelle x die zwei Bereiche briefing/lage =36 Pfadfaelle, je Entwurf plus Pruefung, hoechstens72 Aufrufe, kein Retry, innerhalb4 USD. Offen: 18 Faelle einfrieren, Ausfuehrer und Bindung, ausdrueckliche Kostenfreigabe; danach frische500er Versorgung,1500 Positionen, belastbares Testende und Rueckweg. Alle504 Profile bleiben inaktiv.
[Beleg](betrieb/prosa-sachpruefung-vertrag-2026-09-21.md).
