...
**11.09.2026, gebundener Korrekturadapter vorbereitet, 500 weiter offen:** Production unveraendert PR 380, main `9baa6a3285c19483d18814be0dff6bce68b8a746`, Hauptalias und `dpl_5vMAhzRK3ZDdKD5RhwzMv14JSobr` READY. App Beleg unveraendert: 500 gelesen, 16 abrufbar und strukturell vollstaendig, 484 fehlen, 0 Fachabnahmen. SQL 16:58 UTC: 504 Profile, fuenf Originale aktiv, 495 synthetische inaktiv, 505 Identitaeten; keine aktive Sperre, Lease oder junger Prozess. 0.745625 USD inklusive voller unbekannter Reserve, Automation aus. [PR Entwurf 381](https://github.com/ernisch/helmut-pilot/pull/381) wird auf demselben Branch um einen rein lesenden Korrekturadapter erweitert: vollstaendige Ersatzobjekte, exakter Ursprung, geschlossene Auswahl und sichtbare Begrenzung im Radar. Echter lokaler Aufbau aus 500 erhaltenen Objekten: fuenf Entwuerfe, 20 zur Klaerung zurueckgehaltene Karten, 475 ausserhalb der Auswahl. 113 Fachtextvorkommen entsprechen 30 eindeutigen Texten mit Vorgangsbezug; sieben Ausgabevorkommen bleiben gesondert pruefpflichtig. Technische Metadaten bleiben hashgebunden. Acht Korrekturgruppen bestanden. Gesamtlauf 355/360 in 612 Sekunden; veraltete Radartexterwartung danach korrigiert und 115/115 Radarpruefungen bestanden. Vier bekannte lokale Voraussetzungen fehlen: Chromium fuer zwei Suiten, ical.js und AWS SQS Bibliothek. Pflicht CI am neuen PR Kopf ausstehend. Kein Gesamturteil und kein schreibender Import: ohne separat gebundenes Fachurteil bleibt der Textlauf gesperrt. Rangfolge, unabhaengige Fachabnahme und der spaetere freigegebene Production Schritt bleiben offen. [Entwurf, Beleg und Grenzen](betrieb/500-briefing-quellenpflicht-2026-09-11.md).
