...
**14.09.2026: Übernahme gesichert; neue private Inhaltsgrundlage teilweise belegt, vollständige Inhaltsabnahme blockiert.** Remote Ausgang main `4bc23ca5dffec1513ab7541e58a81cfabb2c5a2c`, PR399/400 gemergt. Production `dpl_DxGWce9GwSBSDBSJegcDR3SQkMgo` READY mit exaktem Commit und Hauptalias frisch bestätigt. Main CI34881674476 erfolgreich. [Kanonischer Beleg](betrieb/500-lage-quellenfenster-2026-09-13.md#separat-datierte-inhaltsgrundlage-am-14092026).

**Neue begrenzte Inhaltsarbeit:** Drei Originalbelege zu Autobahnfinanzierung, Regierungszuschreibung Leipzig und Jobcenterprüfung in einer ausdrücklich privaten30er Inhaltsprobe gebunden. Neun neue Sachtextvarianten gelesen; alle30 ursprünglichen Karten erhalten,37 Quellenzeilen und358 exakt gebundene Textstellen.31 Quellenzeilen bleiben ohne Auszug. Originalaufnahme, Profil und negative Urteile erhalten. Technische Integrität positiv, vollständiger Einzel und Gesamtvertrag weiter negativ. Keine Productionmitschnitt oder500er Behauptung.

**Neue belegte Grenze:** Die ursprüngliche Rohbasis zeigt am Abend wegen abgelaufener relativer Fristen nur20 statt30 Karten; alle10 Unterschiede mit unveränderten Quellen und echtem Zeitfilter geprüft. Eine Übernahme der korrigierten30 Objekte in den gesamten500er Wissensausschnitt verändert außerdem die Quellenauswahl. Die Aufnahmeprüfung verweigert korrekt die Gleichsetzung. Die private30er Probe belegt weder diese globale Auswahl noch die470 weiteren Objekte. Neuer Quellensatz und neues Urteil sind nicht auf den alten gespeicherten Kontext übertragbar.

**Vor exakt500 offen:** passende vollständige Quellenbasis, Inhalts und Prioritätsabnahme, tatsächlicher Urteilsweg, aktuelle Konfiguration/Budget/Sperren und unabhängiges Testende. Unzugängliche Vollartikel/Clips bleiben Grenzen; keine Beschaffung durch den Betreiber verlangen. Keine Profile, Modelle, Productiondaten oder Budgets verändert. Datenkorrekturen sind nicht freigegeben;500er Start ausgeschlossen. Nächster Schritt: frische vollständige Quellenaufnahme über bestehenden Leser und genauer Korrekturbedarf. Hier weiter, Hoch.
