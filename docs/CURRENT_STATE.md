...
**Stand: 06.09.2026. #313 gemergt (`d230067`), ausgerollt als `dpl_DzrNcPGcmkfzin4RHugVb1rG3bUA`, READY 13:12:32 UTC.** **500 Kontoanlagen mit PostgreSQL und fünf Prozessen belegt**, vollständiger Betrieb weiter **BLOCKIERT**: SQL Zugang scheitert auch in der neuen Fortsetzung. Letzte Grundlinie 00:28 UTC: **29 Profile, 25 aktiv, vier inaktiv**. Frische Daten, Kosten und Fachnachweise für 25/100/500 fehlen. Neuer Speicherschutz (**20/20** lokal) ist **gemergt und ausgerollt**, beide Pflichtprüfungen grün; seine Wirkung in Production ist wegen des Datenbankausfalls noch **nicht** belegt. §41 gilt; [Abschluss §47, Ausfall §48, Speicherschutz §49](betrieb/500-funktionstest-sicherheitsrahmen-2026-09-01.md).
...
- **Fortsetzung:** `codex/500-speicher-konsistenz` schützt Leerabrufe, Cache und unklare Schreibantworten (§49). Der geprüfte Nachtrag #311 ist im Branch enthalten; dessen unbelegte Anbieterursache wurde präzisiert. #312 Production: `dpl_CXBA9MNSp77HEir3dTumYGHZ5HS3` READY, Commit `54aedba` exakt bestätigt.
...
1. Speicherschutz (§49) vollständig prüfen und gemäß §41 übernehmen. #309/#310 sind ausgerollt. Erst nach erfolgreicher Minimalabfrage Bestand, Modellkosten und Laufzustände frisch erheben. Speicherdruck ist ein Hinweis, keine belegte Ursache. Neustart und Ressourcenänderung bleiben gesondert freigabepflichtig.
