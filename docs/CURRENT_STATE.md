...
**Stand 09.09.2026, 14:13 UTC: teilweise abgeschlossen; neuer bezahlter Lauf wartet auf konkrete Kostenfreigabe.** PR #347 mit bestehender ausdruecklicher Commit und Mergefreigabe uebernommen: `d0cee4198086dc34a50ce5bd1fa00065436b1294`, Production READY `dpl_7qCRjinKFKtWwRUeki1D96VnCYJm` am Hauptalias bestaetigt. PR Kopf `a59e03f22dc6b2af331de2a8cb77a76644942123` und echter Merge tragen den gleichen Baum `8c6aa4a327e24f40620549c288112192d48309fe`. CI `34360404495` erfolgreich: 345/345 Offline Suiten in 656 Sekunden, 50 Browserpruefungen, 13 PostgreSQL Kontoschutz und Geldgruppen, 48 Z22 Datenbankpruefungen. Rein lesender Lauf `34362141423` bestaetigt in Production Version 2, aktiven 4 USD Deckel und maximal 1000 manuelle Versuche. Keine Aktivierung, kein neuer bezahlter Fachlauf durch den Merge.

**Deployte Vorbereitung:** Harte, vor HTTP atomar reservierte Geldgrenze von 4 USD je UTC Tag im bestehenden gesperrten Production Testmodus. Historische heutige Tokens und regulaere Textmodellaufrufe zaehlen mit; maximal 1000 manuelle Modellversuche in sechs Stunden. Keine automatische Fortsetzung. [Technischer Vertrag und Belege](betrieb/500-kostenbremse-2026-09-09.md). PR #346 hatte zuvor die Quellenreparatur unter Historienerhalt deployt (`15c5800bfa13a9e8b54078502b95c4c9b8c19797`, CI 344/344 bestanden). Dieser reine Abschlussnachtrag wird in PR #345 auf Branch `codex/344-production-uebergabe-20260909` nachgefuehrt. Die Modellarbeit benoetigt eine konkrete Freigabe nach CLAUDE.md §5; die Codeveroeffentlichung ist bereits freigegeben und erledigt.

**Betreiberanweisung 09.09.2026:** Alle Profile, einschliesslich der fuenf bisher als real bezeichneten, sind ungenutzte Testprofile. Ihr besonderer Verfuegbarkeitsvorrang entfaellt fuer diesen Sprint. Datenerhalt, Kosten und Ausschluss konkurrierender Laeufe bleiben verbindlich. PR #346 repariert unbelegte Alttexte mit vollstaendiger Historie und verwendet gueltige Texte wieder. `scripts/500-restpruefung.js` prueft die komplette Zielmenge. Die neue Einzeluebersicht und der Betriebsbericht werden separat fuer den Betreiber gesichert und ohne ausdrueckliche Veroeffentlichungsfreigabe nicht zu GitHub uebertragen.

**Letztes geschlossenes Fenster, weiterhin kein 500er Funktionsnachweis:** Exakt 500 aktive Profile waren bestaetigt; der manuelle Fachlauf `34344201231` stoppte an Quellenqualitaet. 44 Lage Texte vorhanden, 456 fehlen; fuenf Briefingpakete, davon null vollstaendig. Abschluss `34344568514` erfolgreich, 495 synthetische Profile inaktiv, fuenf alte Dummyprofile aktiv, alle 504 erhalten. [Historischer Betriebsbericht](betrieb/500-testfenster-2026-09-09.md). Diese Aktivierung wird nicht als vollstaendige Verarbeitung ausgegeben.
