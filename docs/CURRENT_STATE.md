...
**Stand: 2026-08-28 — zuletzt aktualisiert für Z3b bis 500 (§18).** Vollständige
...
- **Offen sind sechs aufeinander aufbauende PRs:** #272 Z3a, #273 Z22, #274 KI Antwortumschlag, #275 Planungszeitbudget, #276 Monitoring, #277 Z3b Tore. Alle sind ungemergt, in Production unbewiesen und nur gegen den jeweiligen Vorgänger mergefähig. #277 steht entfernt auf `7320d4d`; CI `33173604221` ist dort grün, deckt neue lokale Härtungen aber nicht.
...
- **Migrationen:** OP-30-Dateien seit 15.08. angewendet; `20260823043633` seit 23.08. installiert (Doppelbuchung dokumentiert, Runbook §30.6). **Auf `main` offen: `20260720`** (OP-03) **und seit dem Merge von PR #270 zusätzlich F9** (`20260825101500_jobqueue_ankunftskennzahl`) — F9 ist **auf `main`, aber in Production nicht angewendet** (rein lesend gegengeprüft 25.08.: `helmut_job_ankunft` nicht vorhanden) und hat im Anwendungscode bis heute **keinen Aufrufer**. **Neu vorbereitet, noch nicht auf `main`:** `20260826190000_jobqueue_vorbedingung_mandatsfilter` (Z22, §18) — mit Rückweg, nicht angewendet; der Anwendungscode fällt ohne sie auf das alte Verhalten zurück. Jede Anwendung bleibt freigabepflichtig.
...
- **Beweisgrenzen:** lokal sind Schutzverträge gehärtet, aber noch ohne neuen PR-CI; isoliert gegen Supabase ist nur der synthetische Plattformweg bis 500 grün; vollständig im Fachweg 200/500 ist nichts bewiesen; in Production gilt nur die historische Fünferabnahme, das aktuelle Tor ist rot. Offen bleiben Azure (Anmeldung vor Kennworteingabe gesperrt), Google, Büro, Beobachtung, Speicher, Aufbewahrung, Tarif und alle Realstufen ([Aktivierungsplan](betrieb/z3b-aktivierungsplan-2026-08-27.md)).
