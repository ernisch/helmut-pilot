...
**Korrekturen und naechster Schritt:** PR #359 auf `8300e932ca47b081b26fa31eef698a368dad1f37` behebt den JSONB Vergleichsfehler aus Textlauf `34468104132`; 20/20 Quellenbeleg und 6/6 Reparaturpruefungen erfolgreich. Einziger lokaler Gesamtlauf beendet, nur Teilprotokoll; unabhaengige CI `34470686356` laeuft, Browser 50 PASS. main/Production unveraendert `13425f848106631d9e8c02fbbdf71571afac667b` READY. Zusaetzlich sind alle zehn gemeldeten Radar Wiederholungen nachweislich in nicht angezeigten Rohzuordnungen. Getrennte Korrektur auf `codex/500-sichtbare-radarpruefung-20260910` folgt dem echten Clientselektor, bewahrt Rohdaten und erkennt sichtbare Fehler weiterhin; vorher reproduziert, danach 23/23 Pruefungen erfolgreich. Gesamtpruefung dieser zweiten Korrektur folgt nach Ende der aktuellen CI, kein Doppelstart. Beide Korrekturen geprueft veroeffentlichen, dann fehlende Texte und Briefings fortsetzen. Vorhandene Ergebnisse bewahren. Quellenarbeit abgeschlossen: 38 neue Auszuege, 500 Profile mit mindestens einem, 499 mit mindestens zwei. Heutige App Erhebung `34464573511`: 500 gelesen, 375 unvollstaendig, 125 fehlend, null abgenommen. [Belege und Grenzen](betrieb/500-kostenabbruch-2026-09-10.md).
