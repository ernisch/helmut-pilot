...
**`main`-HEAD:** `a05f273` (Merge #146)

> **Offener Production-Zustand seit 2026-07-27, 08:42 UTC — Entscheidung nötig.** Der
> genehmigte CSD-Nachhollauf ist ausgeführt worden und **gescheitert**: statt eines
> CSD-Vorgangs entstanden **19 falsche Verknüpfungen** an den fachfremden Bestandsvorgang
> `vg-angriffen` (Iran/Huthi) und **eine** an `vg-tagesspiegel-20260519-f29ebd`, dessen
> Inhalt dabei überschrieben und der dadurch für Mandanten sichtbar wurde.
> `vorgang_id like 'vg-csd%'` ist weiterhin **0**. Ursache ist ein **neuer** Resolver-Defekt
> **B4-3** (generisches Ereignissubstantiv + doppelt gezählte Flexionsformen), den #145
> nicht abdeckt, weil er nur gegen Magnete mit ≥ 10 Dokumenten validiert wurde.
> **Der Rückweg ist vorbereitet, aber nicht ausgeführt** (freigabepflichtig):
> [`befund-csd-2026-vorgangsverlust.md`](befund-csd-2026-vorgangsverlust.md) §15.7.
> Bis zur Rücknahme gelten 19 CSD-Rohdokumente fälschlich als „verstanden" und werden vom
> regulären Lauf nie wieder angefasst.
