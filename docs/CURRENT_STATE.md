...
**Stand: 08.09.2026. EXAKT 500 AKTIV seit 07:43 UTC.** Bestand unabhaengig bestaetigt: **504/500/4** Profile, Konten unveraendert. Erster echter Fachlauf: 250 Auftraege fertig, Gesamtstatus **`planung-zeitbudget`**. Korrektur in **PR #335**, lokal 338/338 gruen; CI fand nur eine zu lange Statusdatei, die hier gekuerzt wird. Production weiterhin #334 `ee675ed` READY. Kosten 0,161413 USD geschaetzt, 62 Reservierungen. Ueberwachung aktiviert; Testende **09.09., 08:00 UTC / 11:00 Tuerkei**. [Betriebsbeleg SR §61](betrieb/500-funktionstest-sicherheitsrahmen-2026-09-01.md). **Gesamtabnahme noch offen.**
...
- **PR #335:** `codex/500-fortsetzung-20260908` auf #334. Ab 100 Profilen hoechstens vier atomare Einreihungen gleichzeitig, bei erhaltenem Vorrang, Zeitlimit und beobachtetem Schreibabschluss. Regression reproduziert den echten Engpass; lokaler Gesamtlauf 338/338 gruen. CI 337/338 wegen Statusdateigroesse, Browser 40/40 gruen. Die Dokumentationskorrektur wird erneut geprueft; danach Merge, exaktes Production READY und echter Fachlauf. Details SR §61.
