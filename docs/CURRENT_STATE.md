...
**14.09.2026: Textpfad geklärt, aktueller Inhaltsstand erneut geprüft; vollständige Abnahme offen.** Ausgang main `9e7a3e4b0c3b2edaa62e5f3b7035d9f6686c470e`, PR401 gemergt, Production `dpl_EJHMa7mptgnvqvvec87R5D28s4nH` READY samt Commit und Hauptalias. Main CI34887584015 inzwischen beide Jobs erfolgreich. [Kanonischer Beleg](betrieb/500-lage-quellenfenster-2026-09-13.md#textquellen-und-parlamentsaemter-am-14092026).

**Videofrage beantwortet:** Zwei Clipseiten stammen aus der Google Nachrichtensuche zur SPD Fraktion. Gespeichert sind Titel und Links ohne Auszüge. Der geprüfte Motor verwendet Texte, keine Videodateien oder Transkription. Eine Seitenbeschreibung kann eng begrenzte Aussagen tragen; vollständige Videos sind keine pauschale Abnahmevoraussetzung.

**Neuer belegter Produktfehler:** Ein Parlamentsamt erschien ohne Nennung in den Quellen. Die bestehende Ämterprüfung umfasst nun auch Bundestagspräsident, Landtagspräsident und Parlamentspräsident. Drei neue Gegenfälle vorher rot, danach Quellenpflicht29/29. Am selben frischen Lesestand wird die betroffene Karte zurückgehalten:20 auf19 Karten, keine übrige Karte verloren, keine gespeicherten Daten geändert. Branch `codex/quellentext-parlamentsamt-20260914`; Veröffentlichung dieses Kandidaten noch offen.

**Aktuelle Inhaltsprobe:**500 Wissensobjekte um20:02UTC und80 Quellengruppen um20:04UTC rein lesend erfasst; keine atomare Aufnahme oder frische Productionkonfiguration. Der private Entwurf erhält alle19 Karten:216 Textstellen,25 Quellenzeilen,20 ohne Auszug. Historische30er Probe unverändert. Einzel und Gesamturteil weiterhin negativ.

**Vor exakt500 offen:** ausreichender Textkontext, fachliche Priorisierung und vollständiger Urteilsweg; frische Konfiguration, Kosten, Kommunikationsschutz, Sperren und unabhängiges Testende. Keine Aktivierung, Modelle, Datenimporte oder Budgetänderungen. Nächster Schritt: Textkontexte und fachliche Freigabe. Keine Videoanalyse erforderlich. Hier weiter, Hoch.
