...
- **Offen:** §11 (echter PostgREST-Rückfallnachweis), die übrigen still überspringenden Datenbanksuiten, Z3b, Azure, Parserfix (PR #274) und die nächste natürliche Fünferprüfung. Der natürliche Fünferlauf vom 27.08. war wegen eines rohen Steuerzeichens im KI-Umschlag rot; der strikte Fix in PR #274 ist lokal und in Pflicht-CI grün, aber **ungemergt und nicht deployt** — in Production unbewiesen ([Beleg](betrieb/ki-antwortumschlag-parserfix-2026-08-28.md)).
