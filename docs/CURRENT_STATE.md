...
* **Roadmap26.09.: 500er Start blockiert.** [Kostenkorrektur](betrieb/auftragskosten-gesamtgrenze-20260926.md): 18:12 UTC vollständige Tagesbücher einschließlich späterer Crons geprüft. Konservative kumulative Bindung **4,010292 USD**, davon 0,212 USD unbekannt reserviert; frühere Rechnung mit altem 25.09.-Stand zu niedrig. PR625/94227708 produktiv; kumulative Sperre18:29 UTC eingerichtet. Betreiber hat danach Tages- und Gesamtbudget ausdrücklich auf je6USD erhöht; technische Anpassung in Vorbereitung. Offene Reserve bleibt bestehen. [Lage](betrieb/lage-artikelstand-nachweis-20260926.md): PR624/e61d7f91 READY, Wartezeit und unabhängige Nachkontrolle korrigiert; fachlicher Vergleich weiterhin ohne Antwort. [Quellen](betrieb/verstehen-frische18-20260926.md): falsche Friedenspreis-Verknüpfung entfernt und Vollhash-nachgeprüft. 18:10 UTC 500/0, Profilhashes gleich, 0 Jobs/Locks/Leases. [Versorgungsmessung um 16:14 UTC](betrieb/briefing-themenluecke-20260926.md): 127 Tagesprioritäten/373 ohne; keine neue Vollmessung nach dem Cron. Fachliche Themenversorgung, Bereichsabnahme und Kosten-/Zeitplan offen. [Autonomer Auftrag](betrieb/autonom-bis-500-starttor-20260926.md).
...
* **169er Lauf35987448290 vollständig abgearbeitet, fachlich nicht bestanden.**24.09.:122/122 Cluster,81 Aufrufe/0,522795USD;63 gespeichert,14 aktualisiert,34 Duplikate,7 zusammengeführt,4 lokale `unknown`. Kein globaler Abbruch, keine Profilwirkung. Verbrauchte Quittung bleibt gesperrt. Ursachen, vollständige Bilanz und spätere isolierte Nacharbeit im [Laufbeleg §24–25](betrieb/verstehen-einmalig-169-20260922.md) und [Vierer-Beleg](betrieb/verstehen-vier-nacharbeit-20260924.md).
...
* **Kosten:** atomarer technischer Tagesriegel wird gemäß neuem Betreiber-GO auf **6 USD je UTC Tag** angepasst. Alte 10 USD Betreiberfreigaben erhoehen diesen technischen Riegel nicht. Keine neue Kostenfreigabe durch diesen Sprint.
...
* **Freigaben:** Die aktuelle `AGENTS.md` und der [autonome Betreiberauftrag26.09.](betrieb/autonom-bis-500-starttor-20260926.md) sind massgeblich. Gruene auftragsbezogene Merges und regulaere Deployments sind autorisiert. Gesamtkosten dieses Auftrags bis zu6USD. Keine Aktivierung oder500er Test in diesem Auftrag. Historische Merge-GO-Forderungen sind ueberholt.
...
Tagesriegel gemaess neuem Betreiber-GO6USD; Profilschutz besteht. Historischer Basisstand: PR582/bdd05dac Production READY.
