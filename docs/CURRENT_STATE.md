...
**Stand: 06.09.2026, 10:20 Türkei / 09:20 Berlin / 07:20 UTC.** **#306 gemergt**, `main` **`cfd18b2`**, zugehöriges Production Deployment erneut **READY** bestätigt. Nach erneutem Nutzerauftrag wurde der vorbereitete manuelle Leselauf gestartet. **BLOCKIERT: Datenbankabruf scheitert jetzt sowohl über GitHub als auch über den direkten Lesezugang; die nachfolgende Vercel Konfigurationsprüfung wurde deshalb übersprungen.** #307 trennt diese beiden reinen Leseprüfungen und ergänzt sichere HTTP Statusnummern; noch nicht gemergt. Letzte bestätigte Grundlinie von 00:28 UTC: **29 Profile, 25 aktiv, vier inaktiv**, B/C null, Löschmarken null. Kein frischer Bestands oder Kostennachweis seitdem; die natürlichen Morgenläufe sind noch ungeprüft. Ziel exakt 500 bleibt offen. Freigaben und Grenzen aus §41 bestehen fort. Nachweise: [SR §44.3](betrieb/500-funktionstest-sicherheitsrahmen-2026-09-01.md).
...
- **Letzter Code Merge: `cfd18b20019b811b775371d9c11ddb2b6f5f5ba4`** aus **#306**, zwei Eltern `e0da151` und `b0cbd38`. Production **`dpl_3NGtMs7AtsDK8zPQZKKaXdBAp2Gt` READY**, Commit exakt gleich, Alias `helmut-pilot.vercel.app`, am 06.09. um 07:04 UTC erneut bestätigt. 323/323 lokale Offline Suiten, 32/32 Browserprüfungen und externe Pflichtprüfungen am exakten Kopf grün. Neue Statusroute ohne Datenbank oder Account Vorlauf; ihr echter Abruf wurde im manuellen Lauf wegen des vorausgehenden Datenbankfehlers übersprungen.
...
- **#307 offen:** ursprünglich Dokumentationsnachtrag zu #306, nach der neuen Störung um die notwendige Korrektur des Diagnoseworkflows erweitert. Zwei unabhängige reine Leser, numerischer HTTP Status, feste Action Commits. Gezielte Prüfungen 43 und 31 PASS; vollständige Prüfung, Merge und echter Wiederholungslauf stehen aus. #304 bleibt als `e0da151` gemergt.
...
- **Zugang:** GitHub Lesen, Schreiben, Merge und drei frühere geschützte Datenbankleseläufe belegt. Der nach erneutem Nutzerauftrag gestartete manuelle Lauf **34018371687** scheitert am 06.09. um 07:09 UTC beim Datenbankabruf; direkter SQL Lesezugang meldet ebenfalls Verbindungszeitüberschreitungen. Projektmetadaten melden `ACTIVE_HEALTHY`, beweisen aber keine nutzbare Datenbankverbindung. Supabase und Cron Secrets sind im GitHub Kontext vorhanden; Cron Authentisierung, sieben fehlende GitHub Betriebswerte und tatsächliche Production Werte bleiben ungeklärt. Keine neue Vercel CLI Anmeldung; Details SR §44.3.
...
1. **Zugang:** Frühere GitHub Datenbankleseläufe erfolgreich. Neuer manueller Lauf nach Nutzerauftrag tatsächlich gestartet, jetzt Datenbankfehler und übersprungener Statusschritt. #307 macht die Konfigurationsprüfung unabhängig vom Datenbankerfolg, bei weiterhin sichtbarem Jobfehler. Kohortenausführung weiter offen; SR §44.3.
...
9. **500er Funktionstest: BLOCKIERT am gestörten Datenbankzugang und fehlenden Production Konfigurationsnachweis** (§6, SR §44.3). Letzte Grundlinie A aktiv, B/C bedingt freigegeben und noch nicht angelegt; aktuelle Morgenläufe und Kosten ungeprüft. Pipeline Fortschritt mit 25 ist belegt, Lage noch nicht; der frühere Stopp bei 100 ist durch Zähler 124 vom 05.09. widerlegt. Alle Profile sind laut Betreiber synthetisch.
...
1. Den einmaligen manuellen Workflow `500 Testprofile: Zugang nur lesen` ausdrücklich bestätigen lassen, weil die automatische Freigabeprüfung genau den finalen Start verweigert hat. Dann aktuellen main Commit und Production READY erneut prüfen, denselben Commit im Formular eintragen und nur `laufzeit_status` aktivieren. Keine alte Commitangabe nach einem weiteren Merge verwenden. Danach Betriebswerte, Grundlinie, Uhr, Prozesse, Kosten und Kommunikationsriegel prüfen; SR §44.2.
