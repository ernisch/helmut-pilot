...
- **PR #273, #279, #280 und #281 sind gemergt.** Offen bleiben die gestapelten PRs #274–#277; sie wurden **am 29.08. per normalen Merge-Commits auf den aktuellen `main` nachgeführt** (#274 hängt an Basis `main`; lokale Nachweise und Pflicht-CI grün — Beleg: [`betrieb/zehn-mandate-uebergang-2026-08-29.md`](betrieb/zehn-mandate-uebergang-2026-08-29.md)) und brauchen je Merge eine eigene Betreiberentscheidung.
...
- **Offen:** die übrigen still überspringenden Datenbanksuiten, Z3b, Azure, Parserfix (PR #274) und die nächste natürliche Fünferprüfung. **§11 ist seit 29.08. lokal vollständig erbracht** (48 PASS / 0 FAIL gegen PostgreSQL 17.6 + echtes PostgREST 12.2.3, auf allen vier Stapel-PR-Ständen); der fail-closed CI-Schritt dazu liegt als eigener PR vor.
