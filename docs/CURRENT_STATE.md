...
| `HELMUT_TESTLAUF_*` | **Kommunikation am 06.09., 20:28 UTC gesperrt**, Quellenriegel ebenfalls bestätigt; nach Crawl/Lage keine neuen Push Ereignisse oder Outbox Versandquittungen. RPM, TPM, USD und Parallelität haben keinen Laufzeitleser. Historische Zustellungen werden dadurch nicht zu null. |
