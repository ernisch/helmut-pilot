...
**Aktuelle Fortsetzung auf ausdruecklichen Betreiberauftrag 10.09.:** Der unbekannte Modellaufruf soll weitere gedeckte Arbeit nicht global anhalten. Branch `codex/500-kostenabbruch-nachweis-20260910` fuehrt eine volle, dauerhaft gebundene Reserve fuer ungeklaerte Ergebnisse ein; keine Rueckerstattung, keine automatische Wiederholung und weiterhin insgesamt 4 USD je UTC Tag. Auf der gelesenen heutigen Datenkopie bestaetigt: 0,431472 USD bleiben gebunden, ein weiteres maximales Ticket ergäbe 0,643472 USD. Die kuenstlichen 1000 Versuche, sechs Stunden und Morgenwartezeit entfallen. Datenintegritaet, echte Konkurrenz und Gelddeckung bleiben geschuetzt. Der vorbereitete Grundstand ist inzwischen uebertragen; neue Regel noch nicht gemergt oder deployt. [Aktueller Betriebsbeleg und Pruefstand](betrieb/500-kostenabbruch-2026-09-10.md).
...
**Freigegebene 500er Testfenster am 09.09. und 10.09. ausgefuehrt und sicher geschlossen; vollstaendiger Funktionsnachweis weiterhin offen.** Die neuere Betreiberanweisung ersetzt die bisherige Zwischenabnahme bei 100: direkt auf 500 ausbauen und dort abnehmen; seit 08.09. keine vorherige A Abnahme und kein Nachtfenster mehr. Der neue ausdrückliche Zielweg `--ziel=500` ergänzt den vorhandenen Ausführer; keine vorgetäuschte B Abnahme. Vorrang haben Datenintegrität, Kommunikationssperre und höchstens 4 USD Modellkosten insgesamt je UTC Tag. In Production sperrt die alte Regel noch bei unbekannter Abrechnung. Die vorbereitete Regel erlaubt danach nur durch volle Reserven gedeckte weitere Arbeit. Danach Verkaufsreife und P0 Punkte OP-01 bis OP-04; [OP Liste](datenmotor-restliste.md). Kein Kunden- oder Mehrtagesnachweis.
