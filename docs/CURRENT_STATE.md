...
**Stand: 06.09.2026. #312 gemergt (`54aedba`), Production READY.** **500 Kontoanlagen mit PostgreSQL und fünf Prozessen belegt**, vollständiger Betrieb weiter **BLOCKIERT**: SQL Zugang scheitert auch in der neuen Fortsetzung. Letzte Grundlinie 00:28 UTC: **29 Profile, 25 aktiv, vier inaktiv**. Frische Daten, Kosten und Fachnachweise für 25/100/500 fehlen. Neuer Speicherschutz lokal mit **20/20** geprüft, noch nicht ausgerollt; vollständige Prüfungen und Übernahme stehen aus. §41 gilt; [Abschluss §47, Ausfall §48, Speicherschutz §49](betrieb/500-funktionstest-sicherheitsrahmen-2026-09-01.md).
