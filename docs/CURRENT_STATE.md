...
- **ZWEI STRUKTURELLE BLOCKER, jetzt als erzwungene Hürden im Code (§21.4/§21.5):** (1) `briefing_materialization` ist erst ab **18:00 UTC** fällig — im sicheren Fenster 11:36–15:59 entsteht **kein einziges Briefing**, also nicht die sichtbare Produktstufe. (2) Der konservative Tagesbedarf **1.812** übersteigt die in 263 min bei Parallelität 1 möglichen **1.732** (nötig: 276 min). `startbereitschaft()` meldet deshalb von sich aus **nicht startbereit**, auch bei allen acht gesetzten Werten. **Einziger belegbarer Ablauf:** zwei Fenster nacheinander (11:36–15:59, dann **17:36–19:59**) **bei Parallelität 2** — beides ungedeckte, getrennte Betreiberentscheidungen.
