...
**14.09.2026: B055 Fristkorrektur PR392 gemergt und Production READY.** [Beleg](betrieb/500-lage-quellenfenster-2026-09-13.md). Main `88a63c9418dc2244cc6722fd9d0202f5ae07fd23`, READY `dpl_EmQHyPuyNKCmWq4ngPhsiU9VS9kS` am Hauptalias; Startseite HTTP200 mit passender Assetversion. Autonome Freigabe bis unmittelbar vor dem500er Test gilt. Kein500er Start, keine Aktivierung, fuenf reale Profile geschuetzt.

**Ursache und Wirkung:** Zeitnahe Quellen ohne Termintext konnten kuenftige relative Handlungsfristen passieren lassen. Erkannte relative Fristen jetzt konservativ an Quellentext und Zeitanker gebunden; unbelegte Handlungstexte/Fristfelder entfallen nur in Ausgabekopien. Sachinformationen, Quellenwahl, Ranking und bisherige Ablaufpruefung erhalten. Keine gespeicherten KOs geaendert. Ungewohnte gueltige Formulierungen koennen vorsorglich entfallen; keine semantische Vollpruefung.
