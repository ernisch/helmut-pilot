...
**Stand: 2026-08-29 — zuletzt aktualisiert zum Merge und Deployment des Parserfixes (PR #274, §18).** Vollständige
...
- **`main` = `afc807e` = Merge von PR #274** (Parserfix, 29.08. 22:02 UTC); davor `bb0577a9` (#281), `87bed221` (#280). Das Vercel-Production-Deployment zu `afc807e` ist **READY** mit gebundenem öffentlichem Alias (rein lesend über die Vercel-API geprüft).
- **PR #273, #279, #280, #281 und #274 sind gemergt.** Offen bleiben die gestapelten PRs #275–#277 (am 29.08. per normalen Merge-Commits nachgeführt, lokale Nachweise und Pflicht-CI grün — Beleg: [`betrieb/zehn-mandate-uebergang-2026-08-29.md`](betrieb/zehn-mandate-uebergang-2026-08-29.md)) sowie PR #282 (Beweisgatter); jeder Merge bleibt eine eigene Betreiberentscheidung.
...
- **Offen:** die übrigen still überspringenden Datenbanksuiten, Z3b, Azure und die Fünferregression. Der Fünferlauf vom 27.08. war wegen eines rohen Steuerzeichens im KI-Umschlag rot ([Beleg](betrieb/ki-antwortumschlag-parserfix-2026-08-28.md)); **der Fix ist seit 29.08. 22:02 UTC gemergt und deployt** (§2; der 21:30-Lauf lief noch ohne ihn) — die Regression entscheidet der nächste natürliche Lauf. **§11 ist lokal vollständig erbracht** (48/0, PostgreSQL 17.6 + echtes PostgREST); CI-Schritt dazu in PR #282.
