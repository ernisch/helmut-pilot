...
**Letzte Aktualisierung:** 2026-07-29 (**Sprint OP-25: faire Mandantenreihenfolge in den
Mehrmandanten-Crons. TEILWEISE ABGESCHLOSSEN — offline vollständig belegt, Production-Nachweis
offen, PR offen, kein Merge, keine Migration, keine Production-Änderung.** Der Auftrag nennt
...
`systemError` („keine Fairnessgarantie") statt falschem Grün. Tests: neue Suite **118/118**
(18 geforderte Fälle + Grenzbeweis), **Mutationsprobe 7 von 7 rot**, Offline-Suite **169/183**
...
| Punkt | Was fehlt | → OP |
|---|---|---|
| **Faire Mandantenreihenfolge der Mehrmandanten-Crons** (Rotation nach ältestem Versuch, persistent, ohne Migration; Garantie ceil(n/k), Beobachtbarkeit je Mandat) | **Merge + regulärer Production-Lauf**: erwartet werden über die vier Läufe (04/10/16/20 UTC) alle aktiven Mandate mindestens einmal begonnen, belegt über die `[cron/*/fairness]`-Zeilen. Offline vollständig belegt (118/118, Mutationsprobe 7/7 rot) | OP-25 |
...
- **Neu ab Sprint 23B-1:** OP-25 Crawl-Zeitdeckelung (P1) — **Teilstück „Rotation" am 2026-07-29
  umgesetzt** (faire Reihenfolge, Garantie ceil(n/k); Production-Nachweis offen), offen bleiben
  Abdeckungsmessung und Abdeckungsalarm · OP-26 mandantenscharfer Matching-Einstieg (P2)
