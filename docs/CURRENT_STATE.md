...
**11.09.2026, konkreter lokaler Fachentwurf, 500 weiter offen:** Production unveraendert PR 380, main `9baa6a3285c19483d18814be0dff6bce68b8a746`, Hauptalias und `dpl_5vMAhzRK3ZDdKD5RhwzMv14JSobr` READY. App Beleg: 500 gelesen, 16 abrufbar/strukturell vollstaendig, 484 fehlen, 0 Fachabnahmen. SQL 16:35 UTC: 504 Profile, fuenf Originale aktiv, 495 synthetische inaktiv, 505 Identitaeten; keine aktive Sperre, Lease oder junger Prozess. 0.745625 USD inklusive voller unbekannter Reserve, Automation aus. Alle 25 Karten der erhaltenen Eingabe einzeln entschieden: fuenf engere Fassungen mit Belegen und Mandatsbezug, 20 begruendete Auslassungen. 25 Originalobjekte/38 Quelldokumente um 16:46 frisch unveraendert. Echter lokaler Aufbau: fuenf Karten, 204 Textvorkommen; alle verworfenen Vorgaenge auch aus Aliasen entfernt. Keine Gesamtfreigabe: technische Metadaten werden im neuen Aussagenvertrag noch als Artikelbehauptungen erfasst, Radar Leertext ist fuer die eingeschraenkte Auswahl zu weitgehend, Rangfolge und unabhaengiges Fachurteil offen. [PR Entwurf 381](https://github.com/ernisch/helmut-pilot/pull/381) mit unveraendertem Code und erfolgreicher Pflicht CI 359/359, Browser 50, DB 15/Z22 48 bleibt ohne Mergeempfehlung. Reiner Nachtrag auf `codex/381-fachkorrektur-befund-20260911`; kein neuer Production Schritt. [Entwurf, Beleg und Grenzen](betrieb/500-briefing-quellenpflicht-2026-09-11.md).
