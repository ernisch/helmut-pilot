...
**Teilweise abgeschlossen.** Vollständiger Befund mit allen Zahlen: [`betrieb/understanding-telemetrie-korrektur-2026-08-31.md`](betrieb/understanding-telemetrie-korrektur-2026-08-31.md). Lokaler Branch `claude/understanding-telemetrie-korrektur-ty5gb2` — **kein Push, kein PR, kein Merge, kein Deployment, keine Migration, keine Datenänderung**; Production ausschließlich lesend geprüft.
