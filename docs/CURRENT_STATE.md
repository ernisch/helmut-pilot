...
**Getrennt zu lesen:** `main` bleibt `572f5663…`, solange PR #269 **nicht gemergt** ist — die Arbeit dieses Sprints liegt ausschließlich auf dem Zweig. Der jeweils aktuelle **PR-Kopf** ist ein Zweigstand, **kein** Production-Stand: der Dokumentationsabschluss dieses Sprints steht auf Commit `ce5c189` + Dokumentationscommit (siehe Runbook §31.10).
