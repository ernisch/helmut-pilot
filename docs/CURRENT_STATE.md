...
**Stand 10.09.2026: teilweise abgeschlossen, operative Fortsetzung durch konkrete Freigabeablehnung blockiert.** Exakt 500 Profile aktiv, 504 Profilzeilen und 505 Identitaeten erhalten. Textnachlauf `34468104132` ist beendet und fehlgeschlagen: ein neuer Lage Text gespeichert, aber vom Lauf wegen eines JSONB Vergleichsfehlers nicht bestaetigt; ein anderer Text wegen fehlendem Profilbezug abgelehnt. Insgesamt drei heutige Lage Texte, keine 500er Gesamtabnahme. SQL 14:02:42 Tuerkei / 13:02:42 Berlin / 11:02:42 UTC: keine aktiven Sperren, Kosten 0,443539 USD einschliesslich voller alter Reserve von 0,212 USD, Konten unveraendert. Automatic approval review lehnte die Ausloesung des sicheren Testendes fuer 495 synthetische Profile ab: allgemeiner Autonomieauftrag dort nicht als konkrete Deaktivierungsfreigabe akzeptiert. Keine Umgehung, kein neuer Textlauf. Wiederaufnahme bis zu konkreter Freigabe ausschliesslich lesend.

**Technischer Stand und naechster Schritt:** main `13425f848106631d9e8c02fbbdf71571afac667b`, Production `dpl_GyRmeMyLiUmGtU8Gcnujpuj1cMR6` READY. PR #358 und beide Quellenlaeufe erfolgreich: 38 neue Auszuege, alle 500 Profile mit mindestens einem Auszug, 499 mit mindestens zwei, null unversuchte Ziele. Reaktivierung `34467254960` bestaetigt. Kostenregel 2 hat die alte Sperrmarkierung bei voller Reserve tatsaechlich uebernommen; kein pauschaler Abrechnungsstillstand. Lokale Readback Korrektur ersetzt den JSON Zeichenvergleich durch vollstaendigen Inhaltsvergleich; Fehler vorher reproduziert, danach 20/20 Quellenbelegpruefungen und 6/6 Reparaturpruefungen bestanden. Kanonische Sammlung laeuft einmal. Korrektur fertig pruefen und veroeffentlichen; vor weiterer operativer Fortsetzung konkrete Freigabe fuer temporaere Aktivierung und anschliessende Deaktivierung genau der 495 Testprofile einholen. Heutige App Erhebung `34464573511`: 500 gelesen, 375 unvollstaendig, 125 fehlend, null abgenommen. [Belege und Grenzen](betrieb/500-kostenabbruch-2026-09-10.md).
