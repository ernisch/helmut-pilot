...
**Stand 10.09.2026: teilweise abgeschlossen, autonome Fortsetzung freigegeben.** Die Freigabe umfasst temporaeres Aktivieren und anschliessendes Deaktivieren der 495 bestehenden synthetischen Testprofile bei unveraendert 4 USD je UTC Tag. Reaktivierung `34473218573`: 495/495 bestaetigt. SQL 15:59:16 Tuerkei / 14:59:16 Berlin / 12:59:16 UTC: 504 Profile, exakt 500 aktiv, 505 Identitaeten, drei Inhaltsfingerabdruecke unveraendert, keine aktiven Sperren/Leases/verwaisten oder jungen laufenden Prozesse. 89 Tickets, 0,616776 USD gebunden einschliesslich voller alter Reserve 0,212 USD. App Leser `34478635647` beendet: alle 500 gelesen, drei strukturell vollstaendig, 372 unvollstaendig, 125 fehlend. Sechs heutige Lage Texte; volle fachliche Abnahme aller 500 offen.

**Production und naechster Abschnitt:** PR #361 ist gemergt als `f5b3f0b88b51cdb18450bdbc4aae0328be986154`, Hauptalias `dpl_BjwzQAnZ1gfHygfNmFHtzBihHdPh` unabhaengig READY. Kopf, CI Kandidat und Merge haben exakt Baum `ab69f349d8cae06bd3a47d90f47f0aff6beaf588`. CI `34478105888`: 348/348 Suiten in 682s, Browser 50 PASS, Datenbank 15 und 48 PASS. Ein bereits bezahlter privater Entwurf kann nach belegtem Zeitstopp mit seinem fehlenden Review fortgesetzt werden; Besitzer, Tag, Hash, Profil und Quellen muessen passen. Kosten, Zeitgrenzen und Qualitaetspruefung bleiben unveraendert. Der Controller bestaetigt bekannte Zeitstopps erst nach unabhaengigem Prozess, Daten und Kostenabgleich. Die vorausgehenden Textlaeufe `34474606949` und `34475163214` sind beendet; alle 31 neuen Aufrufe abgerechnet. Dieser Postmerge Nachtrag ist vor weiterer Facharbeit gesichert. Naechster Schritt: frischer Konkurrenz und Kostenabgleich, dann vorhandenen Entwurf und weitere Fehlstellen fortsetzen. [Belege und Grenzen](betrieb/500-kostenabbruch-2026-09-10.md).
