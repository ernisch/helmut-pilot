...
**17.09.2026: PR419, PR420 und PR421 offen, Draft, ungemergt; alle drei GitHub CI Laeufe erfolgreich. PR422 behebt die belegte Kuerzung von Ersatztiteln. Fuenfter Folgebranch behandelt doppelte WELT Artikel und widerspruechliche Quellenzeiten. Kein Merge und keine Production Wirkung.**
...
**Vierter Reparaturteil PR422:** Branch `codex/titel-satzgrenze-20260917`, Basis PR421 `1129d9ad8b163ce1ccf16adc0a02d35fbcb96126`. Ersatztitel behalten den bereits vorhandenen ganzen ersten Satz statt einer Kuerzung bei90 Zeichen. Neue Suite8/8 und privater Replay erfolgreich:5 bestaetigte Abbrueche korrigiert,17 weitere Titel und alle anderen Vertragsfelder identisch. Lokal395/397 in649s plus gezielt geschlossene Abhaengigkeitsfehler (Kalender134/134, Paketbau43/43). CI35207010979 am Head `09099cb52521d2efff75c51eb4f6c81bbbcba44c`:397/397 in779s, Browser50, Kontoschutz erfolgreich, aber gesamter Job an15 Minuten abgebrochen und Z22 uebersprungen; **keine erfolgreiche Gesamt CI**. Enger Folgefix erhoeht nur das CI Jobfenster auf20 Minuten, alle Pruefungen und Einzelgrenzen bleiben erhalten. Finaler Head und neuer vollstaendiger CI Ausgang im Draft PR. Keine Quellen oder Faktenabnahme. WELT Artikelvarianten und Quellenzeiten bleiben offen. [Belege und Grenzen](betrieb/titel-satzgrenze-2026-09-17.md).

**Fuenfter Reparaturteil:** Branch `codex/artikelidentitaet-20260917`, Basis PR422 `6528ecabb028fcfbdc97e1ed55c84f2bbc8dfc83`. Belegte WELT Artikelvarianten zaehlen in der Briefingprojektion einmal; alle Belegvarianten bleiben erhalten. Widerspruechliche Publikationszeiten werden nicht willkuerlich aufgeloest und nicht durch Analysezeit als frisch ausgegeben. Neue Suite11/11 und privater Replay erfolgreich: eine Karte samt Empfehlung korrigiert,21 weitere Karten und alle anderen Vertragsfelder identisch. Pflichtgesamtlauf laeuft. Rohdaten und Altpakete unveraendert; fachlich richtiges Datum und Aussagen bleiben ungeprueft. [Ursache, Pruefungen und Grenzen](betrieb/artikelidentitaet-2026-09-17.md).
...
Die fuenf aufeinander aufbauenden Reparaturteile ungemergt pruefen lassen. Nach Abschluss des Artikelsprints den kleinsten belegten Fehler bei Zuschreibung und Ereignisbindung anhand der erhaltenen Originalvergleiche abgrenzen. Quellenversorgung, Ereigniszeit und sachlicher Profilbezug bleiben fachlich offen. Versorgungskapazitaet, begrenzte Fortsetzungsplanung und sicheres Testende vor erneutem500er Nachweis klaeren. Keine neue Startfreigabe aus dieser Codearbeit ableiten.
