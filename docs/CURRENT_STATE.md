...
**Stand 10.09.2026: teilweise abgeschlossen, autonome Fortsetzung wieder freigegeben.** Der Betreiber hat nach der konkreten Freigabeablehnung das temporaere Aktivieren und anschliessende Deaktivieren der 495 bestehenden synthetischen Testprofile ausdruecklich erlaubt, weiterhin innerhalb 4 USD je UTC Tag. Vorflug 14:16:46 Tuerkei / 13:16:46 Berlin / 11:16:46 UTC: keine aktiven Sperren, Leases oder verwaisten laufenden Jobs. main und Production unveraendert READY auf `13425f848106631d9e8c02fbbdf71571afac667b`. Sicheres Testende danach einmal gestartet, Ausgang noch offen. Letzter Datenstand 500 aktiv, 504 Profile und 505 Identitaeten erhalten; drei heutige Lage Texte, keine Gesamtabnahme. Kosten 0,443539 USD einschliesslich voller alter Reserve von 0,212 USD.

**Technischer Stand und naechster Schritt:** Textnachlauf `34468104132` beendet, fehlgeschlagen: ein neuer gueltiger Text wegen JSONB Schluesselreihenfolge faelschlich unbestaetigt; ein anderer wegen fehlendem Profilbezug abgelehnt. Readback Korrektur auf `codex/500-jsonb-readback-20260910` ersetzt JSON Zeichenvergleich durch vollstaendigen Inhaltsvergleich. Fehler vorher reproduziert, danach 20/20 Quellenbelegpruefungen und 6/6 Reparaturpruefungen bestanden. Einzige lokale Sammlung jetzt mit Exit 1 beendet; nur 22 PASS und ein Chromium Fehler sichtbar, kein vollstaendiger Abschluss. Keine Wiederholung; unabhaengige PR CI folgt nach beendetem lokalen Prozess. Erst Testende bestaetigen, Korrektur nach gruener CI veroeffentlichen und fehlende Ergebnisse fortsetzen. Bereits gespeicherten Text erhalten. PR #358 und Quellenlaeufe abgeschlossen: 38 neue Auszuege, alle 500 Profile mit mindestens einem, 499 mit mindestens zwei. Heutige App Erhebung `34464573511`: 500 gelesen, 375 unvollstaendig, 125 fehlend, null abgenommen. [Belege und Grenzen](betrieb/500-kostenabbruch-2026-09-10.md).
