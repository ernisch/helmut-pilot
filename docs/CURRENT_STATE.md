...
* **Roadmap26.09.: keine500er Startbereitschaft.** PR600/c17a591b Production READY; Medium-Review36228851735 nach20s Timeout abgebrochen. Kein neuer Lage-Text, ganzer Altstand und Profilhashes unveraendert.500 Profile/0 aktiv; keine Jobs/Sperren/Leases. Quittung um08:15UTC kontrolliert auf `gestoppt` geschlossen. Tagesbuch0,153824USD plus0,212USD unbekannte Vollreserve; weitere Modellnachweise gesperrt. Abschlussfehler korrigiert, Review-Aufwand wird auf `low` zurueckgesetzt. Lokale500er Auswertung mit echten Vektoren und Vorabendfenster:3 frische Prioritaeten,497 ohne. [Abnahme, Kosten und Grenzen](betrieb/lage-datumsbindung-20260926.md), [Dauerauftrag](betrieb/autonom-bis-500-starttor-20260926.md).
