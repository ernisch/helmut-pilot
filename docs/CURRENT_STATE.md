...
**Stand 10.09.2026: teilweise abgeschlossen, autonome Fortsetzung freigegeben.** Die ausdrueckliche Freigabe umfasst temporaeres Aktivieren und anschliessendes Deaktivieren der 495 bestehenden synthetischen Testprofile bei unveraendert 4 USD je UTC Tag. Reaktivierung `34473218573`: 495/495 bestaetigt. SQL 15:13:59 Tuerkei / 14:13:59 Berlin / 12:13:59 UTC: 504 Profile, exakt 500 aktiv, 505 Identitaeten, drei Inhaltsfingerabdruecke unveraendert, null aktive Sperren/Leases/verwaiste oder junge laufende Prozesse. 89 Tickets, 0,616776 USD gebunden einschliesslich voller alter Reserve 0,212 USD. Sechs heutige Lage Texte und drei strukturell vollstaendige Briefingpakete; vollstaendige fachliche Abnahme aller 500 offen.

**Production und konkrete Fortsetzung:** PR #359 behebt den JSONB Inhaltsvergleich, #360 die Pruefung der sichtbaren Radar Daten. main `df6d6746557b2a2925686c03752c601e79e48de0`, Hauptalias `dpl_CTYU9Sr9pyPP6MVuKt1WRBKFygU7` READY. CI `34473019264`: 348/348 Suiten in 667s, Browser 50 PASS, Datenbank 15 und 48 PASS; anschliessende main CI erfolgreich. Textlaeufe `34474606949` und `34475163214` beendet: drei neue Texte samt Briefings unabhaengig gespeichert bestaetigt. Der zweite Lauf stoppte vor dem Review des letzten bezahlten Entwurfs an der Zeitgrenze; alle 15 neuen Aufrufe abgerechnet, keine neue unbekannte Rechnung. Auf `codex/500-entwurf-fortsetzen-20260910` ist die gezielte Fortsetzung dieses privaten Entwurfs vorbereitet. Wiederverwendung nur nach beendeter Zeitgrenze, ohne vorhandenes Review und bei unveraendertem Profil/Quelleninhalt; Kosten und Qualitaet weiter voll pruefen. Der Controller soll bekannte Zeitstopps erst nach unabhaengigem Abgleich als geklaert melden. Gezielte Pruefungen bestanden. Lokale Sammlung 346/348 in 572s; zwei fehlende Browser. Der danach ergaenzte Abbruchgrundabgleich besteht 24 gezielte Controllerfaelle. Die unabhaengige PR CI prueft den endgueltigen Stand. Bis zur geklaerten Fortsetzung kein weiterer Textlauf. [Belege, Quellenarbeit und Grenzen](betrieb/500-kostenabbruch-2026-09-10.md).
