...
|---|---|---|
| **#140** | **Phase-1-Punkt 14B: Berliner Abnahmeprofil ausführbar vorbereiten, Sicherungslücke schließen** (aktiviert nichts) | **mergefähig.** Basiert auf `4bc58dc` (nach #139). Reine Werkzeug-/Doku-Arbeit: 4 freigabepflichtige SQL-Dateien, die niemand ausführt, ein read-only Dry Run, ein neuer Backup-Umfang. Keine Production-Mutation, `helmut-flags.json` unverändert. Branch `claude/helmut-production-berlin-prep-l0lfbg`, Commit `a476f21` |
