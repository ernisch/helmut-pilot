...
- **Nach-Merge-Beleg vollständig (§22):** PR #295 gemergt 02.09. 13:08:53 UTC, Merge-Commit `9079ac3` (Eltern `881739da` + `04b9f076`), beide Pflicht-Checks grün (Lauf 33634007860). **Die zuvor nicht auslesbare Vercel-Kennung ist jetzt belegt:** `dpl_DHTnMxFsibaj3XxdkpgDzandursx`, READY, Ziel `production`, exakt auf `9079ac3`. Rein lesend nachgezählt: 9/5/4 Mandatsprofile, 10 Identitätsprofile, **0 synthetische Zeilen**, 35 Migrationen, 13 Crons — alles unverändert.
...
- **Keine Lösung ausgewählt.** Vier Wege bewertet (§23.5); der einzige rechnerisch tragfähige (zwei Fenster bei Parallelität 2) hängt an zwei ungedeckten Betreiberentscheidungen. Kein riskanter Ersatz gebaut.
