...
| `MANDATE_LOOKUP_TIMEOUT_MS` (Default 6500) | O | Timeout je externem Aufruf der Mandatserkennung (Onboarding, Abgeordnetenwatch/DIP). | mandate-lookup.js · alle · Default greift · fail-safe (source_down) |
