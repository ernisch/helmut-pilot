# Frische17: gebundene Quellenversorgung

Der Auftrag verarbeitet genau17 bereits gelesene Quellen mit fest gebundenen
Originalabsaetzen:13 Deutschlandfunk- und4 Tagesschau-Artikel. Eingabe- und
Belegdateien bleiben lokal; die unveraenderlichen Bindungen stehen in
`lib/helmut/verstehen-frische17-vertrag.js`.

## Grenzen und Abnahme

* Einmalquittung `verstehen-frische17-20260926-a`, keine Wiederaufnahme alter Auftraege.
* Hoechstens17 Modellaufrufe,0,80USD und15 Minuten. Tagesriegel bleibt4USD.
...
* Bei fehlendem/zweifelhaftem Einzelergebnis, Kosten-, Zeit-, Speicher- oder
  Bindungsfehler stoppen. Alle17 Positionen muessen bilanziert werden.
...
Der Workflow `verstehen-frische17.yml` bindet main, Dispatch und Checkout an denselben
...
`scripts/quellen-frische17-plan.js` erzeugt den exakt gebundenen Import und
