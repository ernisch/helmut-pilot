...
Weitere Pflichtpruefungen werden vor dem PR dokumentiert. Alle Tests laufen ueber `scripts/lokal.js`, ohne Production Zugang. Kein abgeschlossener Production Nachweis aus diesen lokalen Simulationen.
...
| Dieser Folgebranch | Morgenpaket speichern und gegenlesen; spaetere Ergaenzung; ehrliche Versorgung | Pflicht CI, Review und spaetere Production Wirkung |
