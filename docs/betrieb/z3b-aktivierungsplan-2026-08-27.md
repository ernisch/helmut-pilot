...
> **Übernahmehinweis 01.09.2026:** Dieser datierte Plan wurde aus PR #277 als
> historischer Beleg übernommen. Für den aktuellen Code-, Gate- und Freigabestand
> gelten `docs/CURRENT_STATE.md` und
> `docs/betrieb/500-mandate-theoretische-bereitschaft-2026-09-01.md`. Insbesondere
> ersetzt die später gewählte Minimal-Cron-Architektur die hier noch beschriebene
> große Transportperspektive; erledigte Tests werden nicht wiederholt.
