...
| **Welche Prüfungen liegen vor?** | Offline-Suite **160/160**, Browser-Smoke **32/32**, drei neue Suiten (Identität 52, Lebenszyklus 55, CSD-Regression 38 Assertions); Production-Messung read-only nach §10/§11 |
