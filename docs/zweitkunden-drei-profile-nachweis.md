...
vier Produktflächen (**Lage, Radar, Helmut, Büro**) geschickt — parallel zu Cem, dem
bestehenden Piloten. Alles läuft **rein im Testprozess** (kein Netz, keine Datenbank,
...
**Achelwilm teilt Cems Partei (Die Linke)** — das ist der schärfste Trennungsbeweis:
...
| 4 | **Eigene Radar-Inhalte** | Jedes Profil erkennt seine **eigene Erwähnung**; Cems Personen-Erwähnung (Ince) taucht bei **keinem** neuen Profil auf. |
| 5 | **Eigene Helmut-Empfehlungen** | Top-Empfehlung = eigenes Fachfeld, Stufe „Sofort reagieren"; Entscheidungs-ID trägt die Mandanten-ID. Achelwilm-Top ≠ Cem-Top trotz gleicher Partei. |
...
| 8 | **Keine Inhalte von Cem** | Kein neues Profil bekommt Cems Arbeit-und-Soziales-Vorgang als Top-Karte/-Empfehlung oder Eigenerwähnung. Cem behält sein Fachfeld unverändert. |
...
und eigenem Kostenlimit, **ohne** Inhalte von Cem und **ohne** erfundene Inhalte. Der
