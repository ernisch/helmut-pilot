...
// Vollständiger Bundestags-Kern (ohne die optionalen Felder!).
const btCore = {
...
const ltCore = { id: "mandat-l", fullName: "Lea Berg", role: "MdL", parliamentType: "Landtag", party: "Grüne", constituency: "Hannover-Mitte" };
