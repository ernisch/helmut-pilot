...
async function main() {
  ...
  if (argv.some((a) => a.startsWith("--ziel"))) {
    ...
    if (![...WERKZEUGE, "vorpruefung", "reaktivierung", "fachzyklus", "textnachlauf", "quellenkontext"].includes(werkzeug)
      ...
      abbruch("Direktziel: nur provisionierung|aktivierung|reaktivierung|vorpruefung|fachzyklus|textnachlauf|quellenkontext --ziel=500, optional --scharf. "
