...
function pruefeAzureBericht(bericht, {
  ...
  const b = nurSchluessel(bericht, [
    "schemaVersion", "art", "ergebnis", "modus", "laufKennung", "vorprobeLauf", "erhobenUtc",
  ...
  if (b.vorprobeLauf === b.laufKennung) {
    throw new Error("Azure Stichprobe fuehrt sich selbst als Vorprobe");
  }
