...
const reordered = { ...e, meta: Object.fromEntries(Object.entries(e.meta).sort(([a], [b]) => a.localeCompare(b))) };
A.deepEqual(T.entschluesseln(reordered, pem, ctx), payload);
A.throws(() => T.entschluesseln({ ...reordered, meta: { ...reordered.meta, fremd: true } }, pem, ctx));
A.throws(() => T.entschluesseln({ ...reordered, meta: { ...reordered.meta, anzahl: "5" } }, pem, ctx));
