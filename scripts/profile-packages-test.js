...
check("reines Bundestagsprofil: 55 Abrufwege (NICHT 144)", aReinBT.activePathCount === 55);
...
check("Berliner Landtag: bund-basis aktiv (55), berlin-basis requested_unsupplied", aBerlin.activePathCount === 55 && aBerlin.packageStatus.find((p) => p.key === "berlin-basis").activation === "requested_unsupplied");
check("Brandenburger Landtag: bund-basis aktiv (55), brandenburg-basis requested_unsupplied", aBB.activePathCount === 55 && aBB.packageStatus.find((p) => p.key === "brandenburg-basis").activation === "requested_unsupplied");
