...
const KEY = "prosaEinordnung20260921", PREFIX = "EINORDNUNG_EINMAL:";
const BRANCH = "codex/prosa-einordnung-versuch-20260921", TAG = "2026-09-21";
...
function paket() {
  ...
  return { ...p, basisHash: vertrag.basisHash,
    paketHash: hash({ ...p, entwurfSchema: AI.ENTWURF_SCHEMA, pruefSchema: AI.PRUEF_SCHEMA,
